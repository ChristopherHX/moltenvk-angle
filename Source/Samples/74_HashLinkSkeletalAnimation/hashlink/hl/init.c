...
extern hl_type t$$SkeletalAnimationSample;
extern hl_type t$SkeletalAnimationSample;
...
void fun$init() {
	...
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$SkeletalAnimationSample;
	r2 = &t$SkeletalAnimationSample;
	r3 = (vbyte*)USTR("SkeletalAnimationSample");
	r4 = Type_initClass(r1,r2,r3);
