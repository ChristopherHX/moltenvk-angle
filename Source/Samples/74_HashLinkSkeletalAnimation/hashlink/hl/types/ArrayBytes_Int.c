...
String hl_types_ArrayBytes_Int_join(hl__types__ArrayBytes_Int r0,String r1) {
	...
	r5 = r0->length;
	label$d0a53a9_2_4:
	if( r4 >= r5 ) goto label$d0a53a9_2_20;
	r6 = r4;
	++r4;
	r8 = 0;
	if( r8 >= r6 ) goto label$d0a53a9_2_12;
...
vdynamic* hl_types_ArrayBytes_Int_pop(hl__types__ArrayBytes_Int r0) {
	...
	r1 = r0->length;
	r2 = 0;
	if( r1 != r2 ) goto label$d0a53a9_3_5;
	r3 = NULL;
	return r3;
	label$d0a53a9_3_5:
	r1 = r0->length;
...
int hl_types_ArrayBytes_Int_push(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r2 = r0->length;
	r4 = r0->size;
	if( r4 != r2 ) goto label$d0a53a9_4_5;
	hl_types_ArrayBytes_Int___expand(r0,r2);
	goto label$d0a53a9_4_8;
	label$d0a53a9_4_5:
	r4 = r0->length;
	++r4;
	r0->length = r4;
...
void hl_types_ArrayBytes_Int_reverse(hl__types__ArrayBytes_Int r0) {
	...
	r3 = r3 >> r4;
	label$d0a53a9_5_4:
	if( r1 >= r3 ) goto label$d0a53a9_5_29;
	r4 = r1;
	++r1;
	r5 = r0->length;
	r6 = 1;
...
vdynamic* hl_types_ArrayBytes_Int_shift(hl__types__ArrayBytes_Int r0) {
	...
	r2 = r0->length;
	r3 = 0;
	if( r2 != r3 ) goto label$d0a53a9_6_5;
	r4 = NULL;
	return r4;
	label$d0a53a9_6_5:
	r5 = r0->bytes;
...
void hl_types_ArrayBytes_Int_blit(hl__types__ArrayBytes_Int r0,int r1,hl__types__ArrayAccess r2,int r3,int r4) {
	...
	r8 = 0;
	if( r1 < r8 ) goto label$d0a53a9_7_14;
	r8 = 0;
	if( r3 < r8 ) goto label$d0a53a9_7_14;
	r8 = 0;
	if( r4 < r8 ) goto label$d0a53a9_7_14;
	r7 = r1 + r4;
	r8 = r0->length;
	if( r8 < r7 ) goto label$d0a53a9_7_14;
	r7 = r3 + r4;
	if( r5 == NULL ) hl_null_access();
	r8 = r5->length;
	if( r8 >= r7 ) goto label$d0a53a9_7_17;
	label$d0a53a9_7_14:
...
hl__types__ArrayBase hl_types_ArrayBytes_Int_slice(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	r5 = 0;
	if( r1 >= r5 ) goto label$d0a53a9_8_9;
	r4 = r0->length;
	r4 = r4 + r1;
	r1 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$d0a53a9_8_9;
	r4 = 0;
	r1 = r4;
	label$d0a53a9_8_9:
	if( r2 ) goto label$d0a53a9_8_12;
	r5 = r0->length;
	goto label$d0a53a9_8_20;
	label$d0a53a9_8_12:
	r5 = r2 ? r2->v.i : 0;
	r6 = 0;
	if( r5 >= r6 ) goto label$d0a53a9_8_17;
	r6 = r0->length;
	r5 = r5 + r6;
	label$d0a53a9_8_17:
	r6 = r0->length;
	if( r6 >= r5 ) goto label$d0a53a9_8_20;
	r5 = r0->length;
	label$d0a53a9_8_20:
	r5 = r5 - r1;
	r7 = 0;
	if( r5 >= r7 ) goto label$d0a53a9_8_26;
...
void hl_types_ArrayBytes_Int_sort(hl__types__ArrayBytes_Int r0,vclosure* r1) {
	...
	r3 = &t$_i32;
	r4 = &t$_i32;
	if( hl_same_type(r3,r4) != 0 ) {} else goto label$d0a53a9_9_8;
	r5 = r0->bytes;
	r6 = 0;
	r7 = r0->length;
	hl_bsort_i32(r5,r6,r7,r1);
	goto label$d0a53a9_9_16;
	label$d0a53a9_9_8:
	r5 = r0->bytes;
	r6 = 0;
	r7 = r0->length;
	if( r1 ) goto label$d0a53a9_9_14;
	r8 = NULL;
	goto label$d0a53a9_9_15;
	label$d0a53a9_9_14:
...
hl__types__ArrayBase hl_types_ArrayBytes_Int_splice(hl__types__ArrayBytes_Int r0,int r1,int r2) {
	...
	r5 = 0;
	if( r2 >= r5 ) goto label$d0a53a9_10_5;
	...
	label$d0a53a9_10_5:
	r5 = 0;
	if( r1 >= r5 ) goto label$d0a53a9_10_14;
	r4 = r0->length;
	r4 = r4 + r1;
	r1 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$d0a53a9_10_14;
	r4 = 0;
	r1 = r4;
	label$d0a53a9_10_14:
	r5 = r0->length;
	if( r5 >= r1 ) goto label$d0a53a9_10_21;
	r4 = 0;
	r1 = r4;
	r4 = 0;
	r2 = r4;
	goto label$d0a53a9_10_31;
	label$d0a53a9_10_21:
	r4 = r1 + r2;
	r5 = r0->length;
	if( r5 >= r4 ) goto label$d0a53a9_10_31;
	r4 = r0->length;
	r4 = r4 - r1;
	r2 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$d0a53a9_10_31;
	r4 = 0;
	r2 = r4;
	label$d0a53a9_10_31:
	r5 = 0;
	if( r2 != r5 ) goto label$d0a53a9_10_36;
	r6 = (hl__types__ArrayBytes_Int)hl_alloc_obj(&t$hl_types_ArrayBytes_Int);
	hl_types_ArrayBytes_Int_new(r6);
	return ((hl__types__ArrayBase)r6);
	label$d0a53a9_10_36:
...
String hl_types_ArrayBytes_Int_toString(hl__types__ArrayBytes_Int r0) {
	...
	r4 = r0->length;
	label$d0a53a9_11_6:
	if( r3 >= r4 ) goto label$d0a53a9_11_23;
	r5 = r3;
	++r3;
	r7 = 0;
	if( r7 >= r5 ) goto label$d0a53a9_11_15;
	if( r1 == NULL ) hl_null_access();
	r6 = 44;
...
void hl_types_ArrayBytes_Int_unshift(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r3 = r0->length;
	r4 = r0->size;
	if( r3 != r4 ) goto label$d0a53a9_12_6;
	r3 = r0->length;
	hl_types_ArrayBytes_Int___expand(r0,r3);
	goto label$d0a53a9_12_9;
	label$d0a53a9_12_6:
	r3 = r0->length;
	++r3;
	r0->length = r3;
...
void hl_types_ArrayBytes_Int_insert(hl__types__ArrayBytes_Int r0,int r1,int r2) {
	...
	r5 = 0;
	if( r1 >= r5 ) goto label$d0a53a9_13_10;
	r4 = r0->length;
	r4 = r4 + r1;
	r1 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$d0a53a9_13_9;
	r4 = 0;
	r1 = r4;
	label$d0a53a9_13_9:
	goto label$d0a53a9_13_14;
	label$d0a53a9_13_10:
	r5 = r0->length;
	if( r5 >= r1 ) goto label$d0a53a9_13_14;
	r4 = r0->length;
	r1 = r4;
	label$d0a53a9_13_14:
	r4 = r0->length;
	r5 = r0->size;
	if( r4 != r5 ) goto label$d0a53a9_13_20;
	r4 = r0->length;
	hl_types_ArrayBytes_Int___expand(r0,r4);
	goto label$d0a53a9_13_23;
	label$d0a53a9_13_20:
	r4 = r0->length;
	++r4;
	r0->length = r4;
...
bool hl_types_ArrayBytes_Int_contains(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r5 = -1;
	if( r3 != r5 ) goto label$d0a53a9_14_6;
	r2 = false;
	goto label$d0a53a9_14_7;
	label$d0a53a9_14_6:
	r2 = true;
	label$d0a53a9_14_7:
	return r2;
...
bool hl_types_ArrayBytes_Int_remove(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r6 = 0;
	if( r2 >= r6 ) goto label$d0a53a9_15_6;
	r7 = false;
	return r7;
	label$d0a53a9_15_6:
	r5 = r0->length;
...
int hl_types_ArrayBytes_Int_indexOf(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	if( r2 ) goto label$d0a53a9_16_3;
	r3 = 0;
	goto label$d0a53a9_16_4;
	label$d0a53a9_16_3:
	r3 = r2 ? r2->v.i : 0;
	label$d0a53a9_16_4:
	r5 = 0;
	if( r3 >= r5 ) goto label$d0a53a9_16_13;
	r5 = r0->length;
	r4 = r3 + r5;
	r3 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$d0a53a9_16_13;
	r4 = 0;
	r3 = r4;
	label$d0a53a9_16_13:
	r4 = r3;
	r5 = r0->length;
	label$d0a53a9_16_15:
	if( r4 >= r5 ) goto label$d0a53a9_16_26;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 2;
	r9 = r6 << r9;
	r7 = *(int*)(r8 + r9);
	if( r7 != r1 ) goto label$d0a53a9_16_25;
	return r6;
	label$d0a53a9_16_25:
	goto label$d0a53a9_16_15;
	label$d0a53a9_16_26:
	r4 = -1;
	return r4;
}
...
int hl_types_ArrayBytes_Int_lastIndexOf(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	int r3, r4, r5, r6;
	r3 = r0->length;
	if( !r2 ) goto label$d0a53a9_17_4;
	r4 = r2 ? r2->v.i : 0;
	goto label$d0a53a9_17_6;
	label$d0a53a9_17_4:
	r5 = 1;
	r4 = r3 - r5;
	label$d0a53a9_17_6:
	if( r4 < r3 ) goto label$d0a53a9_17_11;
	r6 = 1;
	r5 = r3 - r6;
	r4 = r5;
	goto label$d0a53a9_17_15;
	label$d0a53a9_17_11:
	r6 = 0;
	if( r4 >= r6 ) goto label$d0a53a9_17_15;
	r5 = r4 + r3;
	r4 = r5;
	label$d0a53a9_17_15:
	r6 = 0;
	if( r4 < r6 ) goto label$d0a53a9_17_26;
	r7 = r0->bytes;
	r6 = 2;
	r6 = r4 << r6;
	r5 = *(int*)(r7 + r6);
	if( r5 != r1 ) goto label$d0a53a9_17_24;
	return r4;
	label$d0a53a9_17_24:
	--r4;
	goto label$d0a53a9_17_15;
...
hl__types__ArrayDyn hl_types_ArrayBytes_Int_map(hl__types__ArrayBytes_Int r0,vclosure* r1) {
	...
	r4 = r0->length;
	r5 = 0;
	if( r5 >= r4 ) goto label$d0a53a9_21_9;
	r4 = r0->length;
	r5 = 1;
	r4 = r4 - r5;
	...
	r5 = r0->length;
	label$d0a53a9_21_11:
	if( r4 >= r5 ) goto label$d0a53a9_21_25;
	r6 = r4;
	++r4;
	if( r2 == NULL ) hl_null_access();
	r8 = r2->array;
...
hl__types__ArrayBytes_Int hl_types_ArrayBytes_Int_filter(hl__types__ArrayBytes_Int r0,vclosure* r1) {
	...
	r5 = r0->length;
	label$d0a53a9_22_4:
	if( r4 >= r5 ) goto label$d0a53a9_22_18;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 2;
	...
	if( !r10 ) goto label$d0a53a9_22_17;
	if( r2 == NULL ) hl_null_access();
	r9 = hl_types_ArrayBytes_Int_push(r2,r7);
	label$d0a53a9_22_17:
	goto label$d0a53a9_22_4;
	label$d0a53a9_22_18:
	return r2;
}
...
void hl_types_ArrayBytes_Int_resize(hl__types__ArrayBytes_Int r0,int r1) {
	...
	int r3, r4, r8, r9;
	r3 = r0->length;
	if( r3 >= r1 ) goto label$d0a53a9_23_6;
	r4 = 1;
	r3 = r1 - r4;
	hl_types_ArrayBytes_Int___expand(r0,r3);
	goto label$d0a53a9_23_20;
	label$d0a53a9_23_6:
	r3 = r0->length;
	if( r1 >= r3 ) goto label$d0a53a9_23_20;
	r5 = r0->bytes;
	r6 = r0->bytes;
	r4 = 2;
	r3 = r1 << r4;
...
vdynamic* hl_types_ArrayBytes_Int_getDyn(hl__types__ArrayBytes_Int r0,int r1) {
	...
	int r2, r3;
	r3 = r0->length;
	if( r1 < r3 ) goto label$d0a53a9_24_6;
	r4 = r0->bytes;
	r2 = 0;
...
void hl_types_ArrayBytes_Int_setDyn(hl__types__ArrayBytes_Int r0,int r1,vdynamic* r2) {
	...
	int r4, r5, r7;
	r5 = r0->length;
	if( r1 < r5 ) goto label$d0a53a9_25_3;
...
void hl_types_ArrayBytes_Int_sortDyn(hl__types__ArrayBytes_Int r0,vclosure* r1) {
	vclosure *r3;
	if( r1 ) goto label$d0a53a9_33_3;
	r3 = NULL;
	goto label$d0a53a9_33_4;
	label$d0a53a9_33_3:
...
void hl_types_ArrayBytes_Int___expand(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r4 = 0;
	if( r1 >= r4 ) goto label$d0a53a9_34_10;
	...
	r3 = r1 + r4;
	r10 = r0->size;
	if( r10 >= r3 ) goto label$d0a53a9_34_41;
	r4 = r0->size;
	r10 = 3;
	r4 = r4 * r10;
	r10 = 1;
	r4 = r4 >> r10;
	if( r4 >= r3 ) goto label$d0a53a9_34_21;
	r4 = r3;
	label$d0a53a9_34_21:
	r8 = r0->bytes;
	r11 = 2;
