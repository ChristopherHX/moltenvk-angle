...
void hl_init_hashes() {
	...
	hl_hash((vbyte*)USTR("yaw"));
	hl_hash((vbyte*)USTR("pitch"));
	hl_hash((vbyte*)USTR("NUM_MODELS"));
	hl_hash((vbyte*)USTR("MODEL_MOVE_SPEED"));
	hl_hash((vbyte*)USTR("MODEL_ROTATE_SPEED"));
	...
	hl_hash((vbyte*)USTR("moveSpeed"));
	hl_hash((vbyte*)USTR("rotationSpeed"));
	hl_hash((vbyte*)USTR("SetParameters"));
