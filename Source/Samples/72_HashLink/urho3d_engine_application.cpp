...
/*
            hl_urho3d_stringhash  * p_stringhash= (hl_urho3d_stringhash *) hl_gc_alloc_finalizer(sizeof(hl_urho3d_stringhash));
            p_stringhash->finalizer = (void*)0;
            p_stringhash->ptr = &eventType; // TBD ELI might need to allocate
           
            vdynamic * dyn_stringhash = hl_alloc_dynamic( &hlt_abstract );
            dyn_stringhash->v.ptr = p_stringhash;

            hl_urho3d_variantmap  * p_variantmap= (hl_urho3d_variantmap *) hl_gc_alloc_finalizer(sizeof(hl_urho3d_variantmap));
            p_variantmap->finalizer = (void*)0;
            p_variantmap->ptr = &eventData;
            vdynamic  * dyn_variantmap = hl_alloc_dynamic( &hlt_abstract );;
            dyn_variantmap->v.ptr = p_variantmap;

            vdynamic *args[2];
            args[0] = dyn_stringhash;
            args[1] = dyn_variantmap;
         
            hl_dyn_call(callback_fn, args, 2);
            */
           hl_urho3d_stringhash * hl_stringhsh = hl_alloc_urho3d_stringhash("test");
        //   vdynamic   dyn_variantmap;
           hl_type abstract = {HABSTRACT};
           abstract.abs_name = (const uchar *)hl_to_utf16("hl_urho3d_stringhash");//_ABSTRACT(hl_urho3d_stringhash);
         //  dyn_variantmap.t = &abstract;
         //  dyn_variantmap.v.ptr = hl_stringhsh;

           

           hl_urho3d_variantmap * hl_variantmap = hl_alloc_urho3d_variantmap();;
           vdynamic   dyn_variantmap2;
           dyn_variantmap2.t = &hlt_abstract;
           dyn_variantmap2.v.ptr = hl_variantmap;

           vdynamic *args[2];
            args[0]= 0;//hl_make_dyn(&test_stringhash, &abstract);
           args[1]=0;
