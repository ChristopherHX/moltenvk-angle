...
void fun$init() {
	urho3d__Application r20;
	String r6;
	hl__Class r4;
	urho3d__$Application r21;
	venum *r10, *r13;
	hl_type *r1, *r2;
	urho3d___Vector3__$Vector3_Impl_ r33;
	$Sys r19;
	bool r18;
	AnimatingSceneSample r23;
	hl_random *r16;
	...
	r12 = 0;
	r11 = ((vdynamic**)(r9 + 1))[r12];
	r13 = (venum*)hl_dyn_castp(&r11,&t$_dyn,&t$haxe_io_Error);
	...
	r4 = Type_initClass(r1,r2,r3);
	r16 = hl_rnd_init_system();
	r17 = ($Std)g$_Std;
	r17->rnd = r16;
	r18 = hl_sys_utf8_path();
	r19 = ($Sys)g$_Sys;
	r19->utf8Path = r18;
	r20 = NULL;
	r21 = (urho3d__$Application)g$_urho3d_Application;
	r21->application = r20;
	r22 = NULL;
	r21 = (urho3d__$Application)g$_urho3d_Application;
	r21->context = r22;
	...
	r12 = 0;
	r17 = ($Std)g$_Std;
	r17->toStringDepth = r12;
	r22 = NULL;
	r25 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r25->context = r22;
	r26 = NULL;
	r27 = (urho3d__$Scene)g$_urho3d_Scene;
	r27->currentScene = r26;
	r29 = &cl$0;
	if( r29 == NULL ) hl_null_access();
	r28 = r29->hasValue ? ((hl_urho3d_math_vector2* (*)(vdynamic*))r29->fun)((vdynamic*)r29->value) : ((hl_urho3d_math_vector2* (*)(void))r29->fun)();
	...
	r31 = r32->hasValue ? ((hl_urho3d_math_vector3* (*)(vdynamic*))r32->fun)((vdynamic*)r32->value) : ((hl_urho3d_math_vector3* (*)(void))r32->fun)();
