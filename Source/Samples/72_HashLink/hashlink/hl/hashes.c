...
void hl_init_hashes() {
	...
	hl_hash((vbyte*)USTR("SubscribeToEvent2"));
	hl_hash((vbyte*)USTR("dynStringHash"));
	hl_hash((vbyte*)USTR("stringHash"));
	hl_hash((vbyte*)USTR("testInt"));
	...
	hl_hash((vbyte*)USTR("add2"));
	hl_hash((vbyte*)USTR("sub2"));
	hl_hash((vbyte*)USTR("mul"));
	hl_hash((vbyte*)USTR("mul2"));
