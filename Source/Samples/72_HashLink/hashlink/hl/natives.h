...
HL_API hl_urho3d_color* Urho3D__sprite_get_color(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_intvector2* Urho3D__sprite_get_hotspot(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_vector2* Urho3D__sprite_get_position(urho3d_context*,hl_urho3d_sprite*);
HL_API float Urho3D__sprite_get_rotation(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_vector2* Urho3D__sprite_get_scale(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_intvector2* Urho3D__sprite_get_size(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_texture2d* Urho3D__sprite_get_texture(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_variantmap* Urho3D__sprite_get_vars(urho3d_context*,hl_urho3d_sprite*);
HL_API int Urho3D__sprite_set_blend_mode(urho3d_context*,hl_urho3d_sprite*,int);
HL_API hl_urho3d_color* Urho3D__sprite_set_color(urho3d_context*,hl_urho3d_sprite*,hl_urho3d_color*);
HL_API hl_urho3d_intvector2* Urho3D__sprite_set_hotspot(urho3d_context*,hl_urho3d_sprite*,hl_urho3d_intvector2*);
HL_API hl_urho3d_vector2* Urho3D__sprite_set_position(urho3d_context*,hl_urho3d_sprite*,hl_urho3d_vector2*);
HL_API float Urho3D__sprite_set_rotation(urho3d_context*,hl_urho3d_sprite*,float);
HL_API hl_urho3d_vector2* Urho3D__sprite_set_scale(urho3d_context*,hl_urho3d_sprite*,hl_urho3d_vector2*);
HL_API hl_urho3d_intvector2* Urho3D__sprite_set_size(urho3d_context*,hl_urho3d_sprite*,hl_urho3d_intvector2*);
...
HL_API float Urho3D__vector2_get_x(hl_urho3d_vector2*);
HL_API float Urho3D__vector2_get_y(hl_urho3d_vector2*);
HL_API float Urho3D__vector2_set_x(hl_urho3d_vector2*,float);
HL_API float Urho3D__vector2_set_y(hl_urho3d_vector2*,float);
