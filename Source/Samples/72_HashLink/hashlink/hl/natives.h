...
HL_API double Urho3D__graphics_light_get_range(urho3d_context*,hl_urho3d_graphics_light*);
HL_API void Urho3D__graphics_light_set_light_type(urho3d_context*,hl_urho3d_graphics_light*,int);
HL_API void Urho3D__graphics_light_set_range(urho3d_context*,hl_urho3d_graphics_light*,double);
...
HL_API vdynamic* hl_dyn_op(int,vdynamic*,vdynamic*);
