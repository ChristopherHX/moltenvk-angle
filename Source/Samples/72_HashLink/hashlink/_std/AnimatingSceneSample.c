...
void AnimatingSceneSample_CreateScene(AnimatingSceneSample r0) {
	...
	hl_urho3d_scene_component *r4, *r14, *r39;
	...
	r30 = r0->NUM_OBJECTS;
	label$d9beba3_3_73:
	if( r29 >= r30 ) goto label$d9beba3_3_158;
	++r29;
	r1 = r0->scene;
	if( r1 == NULL ) hl_null_access();
	r5 = (String)s$Box;
	...
	r13 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r12 = r13->context;
	r38 = Urho3D__graphics_staticmodel_cast_from_component(r12,r14);
	r40 = (urho3d__StaticModel)hl_alloc_obj(&t$urho3d_StaticModel);
	urho3d_StaticModel_new(r40,r38);
	r13 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r12 = r13->context;
	r5 = (String)s$Models_Box_mdl;
	r41 = Urho3D__graphics_model_create(r12,r5);
	r42 = urho3d_StaticModel_set_model(r40,r41);
	r13 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r12 = r13->context;
	r5 = (String)s$Materials_Stone_xml;
	r43 = Urho3D__graphics_material_create(r12,r5);
	...
	r13 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r12 = r13->context;
	r46 = Urho3D__graphics_camera_cast_from_component(r12,r14);
	...
	r6 = NULL;
	r7 = NULL;
	r39 = urho3d_Node_CreateComponent(r10,r5,r6,r7);
	r13 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r12 = r13->context;
	r48 = Urho3D__graphics_light_cast_from_component(r12,r39);
...
void AnimatingSceneSample_MoveCamera(AnimatingSceneSample r0,double r1) {
	...
	urho3d__Node r6;
	hl_urho3d_math_tquaternion *r28, *r31;
	...
	r4 = 0;
	if( r4 >= r3 ) goto label$d9beba3_6_84;
	r6 = r0->cameraNode;
	...
	r12 = 2.;
	if( !r11 ) goto label$d9beba3_6_83;
	r3 = 0;
	r4 = urho3d_Input_get_numTouches();
	label$d9beba3_6_16:
	if( r3 >= r4 ) goto label$d9beba3_6_83;
	r13 = r3;
	++r3;
	r10 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r9 = r10->context;
	...
	r24 = 0;
	if( r19 != r24 ) goto label$d9beba3_6_49;
	r24 = 0;
	if( r20 == r24 ) goto label$d9beba3_6_82;
	label$d9beba3_6_49:
	r25 = r0->yaw;
	...
	r25 = 0.;
	r30 = (float)r25;
	r28 = Urho3D__math_tquaternion_create(r21,r29,r30);
	if( r6 == NULL ) hl_null_access();
	r31 = urho3d_Node_set_rotation(r6,r28);
	label$d9beba3_6_82:
	goto label$d9beba3_6_16;
	label$d9beba3_6_83:
	goto label$d9beba3_6_116;
	label$d9beba3_6_84:
	...
	r25 = -90.;
	r26 = 90.;
	r23 = urho3d_Application_Clamp(((urho3d__Application)r0),r23,r25,r26);
	r0->pitch = r23;
	r6 = r0->cameraNode;
	r23 = r0->pitch;
	r21 = (float)r23;
