...
void drawWindow(VGFrameBuffer* vge, const char* title, float x, float y, float w, float h)
{
...
void drawSearchBox(VGFrameBuffer* vge, const char* text, float x, float y, float w, float h)
{
    NVGpaint bg;
    char icon[8];
...
void drawDropDown(VGFrameBuffer* vge, const char* text, float x, float y, float w, float h)
{
    NVGpaint bg;
    char icon[8];
...
void drawLabel(VGFrameBuffer* vge, const char* text, float x, float y, float w, float h)
{
    NVG_NOTUSED(w);
...
void drawEditBox(VGFrameBuffer* vge, const char* text, float x, float y, float w, float h)
{
...
void drawEditBoxNum(VGFrameBuffer* vge, const char* text, const char* units, float x, float y, float w, float h)
{
    float uw;
...
void drawCheckBox(VGFrameBuffer* vge, const char* text, float x, float y, float w, float h)
{
    NVGpaint bg;
    char icon[8];
    NVG_NOTUSED(w);
...
void drawButton(VGFrameBuffer* vge, int preicon, const char* text, float x, float y, float w, float h, NVGcolor col)
{
    NVGpaint bg;
    char icon[8];
    float cornerRadius = 4.0f;
...
void drawThumbnails(VGFrameBuffer* vge, float x, float y, float w, float h, const int* images, int nimages, float t)
{
    float cornerRadius = 3.0f;
