...
$BillboardsSample g$_BillboardsSample = 0;
haxe__$Log g$_haxe_Log = 0;
String s$Setup = 0;
String s$src_haxe_BillboardsSample_hx = 0;
String s$BillboardsSample = 0;
String s$Octree = 0;
...
String s$MushroomGroup = 0;
String s$Mushroom = 0;
String s$Models_Mushroom_mdl = 0;
String s$Materials_Mushroom_xml = 0;
String s$Smoke = 0;
String s$BillboardSet = 0;
urho3d__$BillboardSet g$_urho3d_BillboardSet = 0;
String s$Materials_LitSmoke_xml = 0;
String s$SpotLight = 0;
String s$Textures_RampExtreme_png = 0;
String s$Camera = 0;
...
urho3d___Node__$PodNode_Impl_ g$_urho3d__Node_PodNode_Impl_ = 0;
...
static struct _String const_s$src_haxe_BillboardsSample_hx = {&t$String,(vbyte*)USTR("src/haxe/BillboardsSample.hx"),28};
static struct _String const_s$BillboardsSample = {&t$String,(vbyte*)USTR("BillboardsSample"),16};
...
static struct _String const_s$FloorTile = {&t$String,(vbyte*)USTR("FloorTile"),9};
...
static struct _String const_s$MushroomGroup = {&t$String,(vbyte*)USTR("MushroomGroup"),13};
...
static struct _String const_s$Smoke = {&t$String,(vbyte*)USTR("Smoke"),5};
static struct _String const_s$BillboardSet = {&t$String,(vbyte*)USTR("BillboardSet"),12};
static struct _String const_s$Materials_LitSmoke_xml = {&t$String,(vbyte*)USTR("Materials/LitSmoke.xml"),22};
static struct _String const_s$SpotLight = {&t$String,(vbyte*)USTR("SpotLight"),9};
static struct _String const_s$Textures_RampExtreme_png = {&t$String,(vbyte*)USTR("Textures/RampExtreme.png"),24};
...
void hl_init_roots() {
	...
	s$src_haxe_BillboardsSample_hx = &const_s$src_haxe_BillboardsSample_hx;
	s$BillboardsSample = &const_s$BillboardsSample;
	...
	s$MushroomGroup = &const_s$MushroomGroup;
	...
	s$Smoke = &const_s$Smoke;
	s$BillboardSet = &const_s$BillboardSet;
	s$Materials_LitSmoke_xml = &const_s$Materials_LitSmoke_xml;
	s$SpotLight = &const_s$SpotLight;
	s$Textures_RampExtreme_png = &const_s$Textures_RampExtreme_png;
	...
	hl_add_root((void**)&g$_BillboardsSample);
	...
	hl_add_root((void**)&g$_urho3d__Node_PodNode_Impl_);
