...
extern hl_type t$urho3d__Node_$PodNode_Impl_;
extern hl_type t$urho3d__Node_PodNode_Impl_;
...
void fun$init() {
	urho3d__Application r22;
	String r6;
	BillboardsSample r25;
	hl__Class r4;
	urho3d__$Application r23;
	venum *r10;
	hl_type *r1, *r2;
	...
	urho3d___Vector2__$Vector2_Impl_ r32;
	hl_urho3d_math_vector2 *r30;
	...
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$urho3d__Node_$PodNode_Impl_;
	r2 = &t$urho3d__Node_PodNode_Impl_;
	r3 = (vbyte*)USTR("urho3d._Node.PodNode_Impl_");
	r4 = Type_initClass(r1,r2,r3);
	...
	r15 = r15 / r17;
	r16 = ($Math)g$_Math;
	r16->POSITIVE_INFINITY = r15;
	r15 = -1.;
	r17 = 0.;
	r15 = r15 / r17;
	r16 = ($Math)g$_Math;
	r16->NEGATIVE_INFINITY = r15;
	r18 = hl_rnd_init_system();
	r19 = ($Std)g$_Std;
	r19->rnd = r18;
	r20 = hl_sys_utf8_path();
	r21 = ($Sys)g$_Sys;
	r21->utf8Path = r20;
	r22 = NULL;
	r23 = (urho3d__$Application)g$_urho3d_Application;
	r23->application = r22;
	r24 = NULL;
	r23 = (urho3d__$Application)g$_urho3d_Application;
	r23->context = r24;
	...
	r12 = 0;
	r19 = ($Std)g$_Std;
	r19->toStringDepth = r12;
	r24 = NULL;
	r27 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r27->context = r24;
	r28 = NULL;
	r29 = (urho3d__$Scene)g$_urho3d_Scene;
	r29->currentScene = r28;
	r31 = &cl$0;
	if( r31 == NULL ) hl_null_access();
	r30 = r31->hasValue ? ((hl_urho3d_math_vector2* (*)(vdynamic*))r31->fun)((vdynamic*)r31->value) : ((hl_urho3d_math_vector2* (*)(void))r31->fun)();
	r32 = (urho3d___Vector2__$Vector2_Impl_)g$_urho3d__Vector2_Vector2_Impl_;
	r32->ZERO = r30;
	r31 = &cl$1;
	if( r31 == NULL ) hl_null_access();
	r30 = r31->hasValue ? ((hl_urho3d_math_vector2* (*)(vdynamic*))r31->fun)((vdynamic*)r31->value) : ((hl_urho3d_math_vector2* (*)(void))r31->fun)();
	...
	r33 = r34->hasValue ? ((hl_urho3d_math_vector3* (*)(vdynamic*))r34->fun)((vdynamic*)r34->value) : ((hl_urho3d_math_vector3* (*)(void))r34->fun)();
