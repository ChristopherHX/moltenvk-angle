...
hl_urho3d_math_quaternion* fun$init__$1() {
	...
	r0 = 0.;
	r1 = NULL;
	if( !r1 ) goto label$e988165_15_6;
	r4 = (float)r0;
	r2 = Urho3D__math_quaternion_create_fv(r4,r1);
	goto label$e988165_15_12;
	label$e988165_15_6:
	r4 = (float)r0;
	r3 = 0.;
	r5 = (float)r3;
...
void fun$init() {
	...
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$MultipleViewportsSample;
	r2 = &t$MultipleViewportsSample;
	r3 = (vbyte*)USTR("MultipleViewportsSample");
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$Reflect;
	r2 = &t$Reflect;
