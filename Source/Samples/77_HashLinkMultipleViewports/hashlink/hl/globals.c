...
String s$Setup = 0;
String s$33d316f = 0;
String s$MultipleViewportsSample = 0;
String s$Octree = 0;
...
static struct _String const_s$RearCamera = {&t$String,(vbyte*)USTR("RearCamera"),10};
static struct _String const_s$PostProcess_Bloom_xml = {&t$String,(vbyte*)USTR("PostProcess/Bloom.xml"),21};
static struct _String const_s$PostProcess_FXAA2_xml = {&t$String,(vbyte*)USTR("PostProcess/FXAA2.xml"),21};
static struct _String const_s$BloomMix = {&t$String,(vbyte*)USTR("BloomMix"),8};
static struct _String const_s$Bloom = {&t$String,(vbyte*)USTR("Bloom"),5};
static struct _String const_s$FXAA2 = {&t$String,(vbyte*)USTR("FXAA2"),5};
...
void hl_init_roots() {
	...
	s$RearCamera = &const_s$RearCamera;
	s$PostProcess_Bloom_xml = &const_s$PostProcess_Bloom_xml;
	s$PostProcess_FXAA2_xml = &const_s$PostProcess_FXAA2_xml;
	s$BloomMix = &const_s$BloomMix;
	s$Bloom = &const_s$Bloom;
	s$FXAA2 = &const_s$FXAA2;
