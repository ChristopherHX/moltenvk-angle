...
#ifndef INC__std__RenderToTextureSample
#define INC__std__RenderToTextureSample
typedef struct _$RenderToTextureSample *$RenderToTextureSample;
typedef struct _RenderToTextureSample *RenderToTextureSample;
#include <hl/Class.h>
...
struct _$RenderToTextureSample {
	hl_type *$type;
	hl_type* __type__;
	vdynamic* __meta__;
...
struct _RenderToTextureSample {
	...
	urho3d__Scene rttScene;
	urho3d__Node rttCameraNode;
	double yaw;
	double pitch;
	int NUM_OBJECTS;
};
