...
extern hl_type t$$RenderToTextureSample;
extern hl_type t$RenderToTextureSample;
...
void fun$init() {
	...
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$RenderToTextureSample;
	r2 = &t$RenderToTextureSample;
	r3 = (vbyte*)USTR("RenderToTextureSample");
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$Std;
	r2 = &t$Std;
	r3 = (vbyte*)USTR("Std");
