...
String s$ScreenBox = 0;
String s$Screen = 0;
String s$Models_Plane_mdl = 0;
String s$Techniques_DiffUnlit_xml = 0;
String s$Update = 0;
...
static struct _String const_s$ScreenBox = {&t$String,(vbyte*)USTR("ScreenBox"),9};
...
static struct _String const_s$Techniques_DiffUnlit_xml = {&t$String,(vbyte*)USTR("Techniques/DiffUnlit.xml"),24};
...
void hl_init_roots() {
	...
	s$ScreenBox = &const_s$ScreenBox;
	s$Screen = &const_s$Screen;
	s$Models_Plane_mdl = &const_s$Models_Plane_mdl;
	s$Techniques_DiffUnlit_xml = &const_s$Techniques_DiffUnlit_xml;
