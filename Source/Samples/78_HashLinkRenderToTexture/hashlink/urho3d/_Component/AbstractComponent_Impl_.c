...
hl_urho3d_physics_rigid_body* urho3d__Component_AbstractComponent_Impl__toAbstractRigidBody(hl_urho3d_scene_component* r0) {
	hl_urho3d_physics_rigid_body *r1, *r4;
	urho3d___Context__$Context_Impl_ r3;
	urho3d_context *r2;
	if( !r0 ) goto label$3b3ff52_11_8;
	r3 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r2 = r3->context;
	r1 = Urho3D__physics_rigid_body_cast_from_component(r2,r0);
	if( !r1 ) goto label$3b3ff52_11_6;
	return r1;
	label$3b3ff52_11_6:
	r4 = NULL;
	return r4;
...
urho3d__Constraint urho3d__Component_AbstractComponent_Impl__toConstraint(hl_urho3d_scene_component* r0) {
	hl_urho3d_physics_constraint *r2;
	urho3d___Context__$Context_Impl_ r4;
	urho3d_context *r3;
	urho3d__Constraint r5;
	if( !r0 ) goto label$3b3ff52_13_10;
	r4 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r3 = r4->context;
	r2 = Urho3D__physics_constraint_cast_from_component(r3,r0);
	if( !r2 ) goto label$3b3ff52_13_8;
	r5 = (urho3d__Constraint)hl_alloc_obj(&t$urho3d_Constraint);
	urho3d_Constraint_new(r5,r2);
	return r5;
	label$3b3ff52_13_8:
	r5 = NULL;
	return r5;
...
hl_urho3d_physics_constraint* urho3d__Component_AbstractComponent_Impl__toAbstractConstraint(hl_urho3d_scene_component* r0) {
	hl_urho3d_physics_constraint *r1, *r4;
	urho3d___Context__$Context_Impl_ r3;
	urho3d_context *r2;
	if( !r0 ) goto label$3b3ff52_14_8;
	r3 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r2 = r3->context;
	r1 = Urho3D__physics_constraint_cast_from_component(r2,r0);
	if( !r1 ) goto label$3b3ff52_14_6;
	return r1;
	label$3b3ff52_14_6:
	r4 = NULL;
	return r4;
...
urho3d__Skybox urho3d__Component_AbstractComponent_Impl__toSkybox(hl_urho3d_scene_component* r0) {
	...
	urho3d_context *r3;
	if( !r0 ) goto label$3b3ff52_15_10;
	r4 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r3 = r4->context;
	r2 = Urho3D__graphics_skybox_cast_from_component(r3,r0);
	if( !r2 ) goto label$3b3ff52_15_8;
...
urho3d__AnimationController urho3d__Component_AbstractComponent_Impl__toAnimationController(hl_urho3d_scene_component* r0) {
	hl_urho3d_graphics_animation_controller *r2;
	urho3d___Context__$Context_Impl_ r4;
	urho3d_context *r3;
	urho3d__AnimationController r5;
	if( !r0 ) goto label$3b3ff52_16_10;
	r4 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r3 = r4->context;
	r2 = Urho3D__graphics_animation_controller_cast_from_component(r3,r0);
	if( !r2 ) goto label$3b3ff52_16_8;
	r5 = (urho3d__AnimationController)hl_alloc_obj(&t$urho3d_AnimationController);
	urho3d_AnimationController_new(r5,r2);
	return r5;
	label$3b3ff52_16_8:
	r5 = NULL;
	return r5;
...
urho3d__LogicComponent urho3d__Component_AbstractComponent_Impl__toLogicComponent(hl_urho3d_scene_component* r0) {
	urho3d___Context__$Context_Impl_ r4;
	urho3d__LogicComponent r5;
	hl_urho3d_scene_logic_component *r2;
	urho3d_context *r3;
	vdynamic *r6;
	if( !r0 ) goto label$3b3ff52_17_11;
	r4 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r3 = r4->context;
	r2 = Urho3D__scene_logic_component_cast_from_component(r3,r0);
	if( !r2 ) goto label$3b3ff52_17_9;
	r5 = (urho3d__LogicComponent)hl_alloc_obj(&t$urho3d_LogicComponent);
	if( r2 == NULL ) r6 = NULL; else {
		r6 = hl_alloc_dynamic(&t$hl_urho3d_scene_logic_component);
		r6->v.ptr = r2;
	}
	urho3d_LogicComponent_new(r5,r6);
	return r5;
	label$3b3ff52_17_9:
	r5 = NULL;
	return r5;
...
hl_urho3d_scene_logic_component* urho3d__Component_AbstractComponent_Impl__toAbstractLogicComponent(hl_urho3d_scene_component* r0) {
	urho3d___Context__$Context_Impl_ r3;
	hl_urho3d_scene_logic_component *r1;
	urho3d_context *r2;
	if( !r0 ) goto label$3b3ff52_18_5;
	r3 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r2 = r3->context;
