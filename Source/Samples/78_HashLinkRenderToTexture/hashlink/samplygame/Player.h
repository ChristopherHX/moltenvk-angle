...
#ifndef INC_samplygame__Player
#define INC_samplygame__Player
typedef struct _samplygame__$Player *samplygame__$Player;
typedef struct _samplygame__Player *samplygame__Player;
#include <hl/Class.h>
