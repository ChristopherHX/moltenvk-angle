...
#ifndef INC_actions__MoveByState
#define INC_actions__MoveByState
typedef struct _actions__$MoveByState *actions__$MoveByState;
typedef struct _actions__MoveByState *actions__MoveByState;
#include <hl/Class.h>
