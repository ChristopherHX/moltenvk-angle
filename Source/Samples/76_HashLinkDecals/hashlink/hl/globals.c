...
String s$Setup = 0;
String s$src_haxe_DecalsSample_hx = 0;
String s$DecalsSample = 0;
String s$Octree = 0;
...
String s$Materials_UrhoDecal_xml = 0;
...
static struct _String const_s$DecalSet = {&t$String,(vbyte*)USTR("DecalSet"),8};
static struct _String const_s$Materials_UrhoDecal_xml = {&t$String,(vbyte*)USTR("Materials/UrhoDecal.xml"),23};
...
void hl_init_roots() {
	...
	s$DecalSet = &const_s$DecalSet;
	s$Materials_UrhoDecal_xml = &const_s$Materials_UrhoDecal_xml;
