...
#ifndef INC_samplygame__Coin
#define INC_samplygame__Coin
typedef struct _samplygame__$Coin *samplygame__$Coin;
typedef struct _samplygame__Coin *samplygame__Coin;
#include <hl/Class.h>
