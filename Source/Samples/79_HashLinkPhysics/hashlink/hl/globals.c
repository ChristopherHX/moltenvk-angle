...
String s$Materials_Skybox_xml = 0;
String s$Floor = 0;
...
String s$Box = 0;
String s$Materials_StoneEnvMapSmall_xml = 0;
String s$Camera = 0;
...
static struct _String const_s$Sky = {&t$String,(vbyte*)USTR("Sky"),3};
static struct _String const_s$Skybox = {&t$String,(vbyte*)USTR("Skybox"),6};
static struct _String const_s$Models_Box_mdl = {&t$String,(vbyte*)USTR("Models/Box.mdl"),14};
static struct _String const_s$Materials_Skybox_xml = {&t$String,(vbyte*)USTR("Materials/Skybox.xml"),20};
...
static struct _String const_s$Materials_StoneEnvMapSmall_xml = {&t$String,(vbyte*)USTR("Materials/StoneEnvMapSmall.xml"),30};
...
static struct _String const_s$SmallBox = {&t$String,(vbyte*)USTR("SmallBox"),8};
...
void hl_init_roots() {
	...
	s$Sky = &const_s$Sky;
	s$Skybox = &const_s$Skybox;
	s$Models_Box_mdl = &const_s$Models_Box_mdl;
	s$Materials_Skybox_xml = &const_s$Materials_Skybox_xml;
	...
	s$Box = &const_s$Box;
	s$Materials_StoneEnvMapSmall_xml = &const_s$Materials_StoneEnvMapSmall_xml;
	s$Camera = &const_s$Camera;
	s$Update = &const_s$Update;
	s$HandleUpdate = &const_s$HandleUpdate;
	s$SmallBox = &const_s$SmallBox;
	...
	hl_add_root((void**)&g$_PhysicsSample);
