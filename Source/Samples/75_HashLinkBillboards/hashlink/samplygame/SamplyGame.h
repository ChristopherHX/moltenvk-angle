...
#ifndef INC_samplygame__SamplyGame
#define INC_samplygame__SamplyGame
typedef struct _samplygame__$SamplyGame *samplygame__$SamplyGame;
typedef struct _samplygame__SamplyGame *samplygame__SamplyGame;
#include <hl/Class.h>
...
struct _samplygame__$SamplyGame {
	hl_type *$type;
	hl_type* __type__;
	vdynamic* __meta__;
	...
	samplygame__SamplyGame mainGame;
};
struct _samplygame__SamplyGame {
	...
	urho3d__Scene scene;
	urho3d__Node gameNode;
	urho3d__Node cameraNode;
	bool playing;
	samplygame__Enemies enemies_;
	samplygame__Player player_;
	samplygame__StartMenu startMenu_;
	urho3d__Node startMenuNode_;
	int coins;
	String CoinsString;
	String HealthString;
