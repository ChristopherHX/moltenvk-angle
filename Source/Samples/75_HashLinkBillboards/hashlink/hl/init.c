...
extern hl_type t$$BillboardsSample;
extern hl_type t$BillboardsSample;
...
void fun$init() {
	...
	r1 = &t$$BillboardsSample;
	r2 = &t$BillboardsSample;
	r3 = (vbyte*)USTR("BillboardsSample");
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$Date;
	r2 = &t$Date;
	r3 = (vbyte*)USTR("Date");
	...
	r22->utf8Path = r21;
	r23 = NULL;
	r24 = (urho3d__$Application)g$_urho3d_Application;
	r24->application = r23;
	r25 = NULL;
	r24 = (urho3d__$Application)g$_urho3d_Application;
	r24->context = r25;
