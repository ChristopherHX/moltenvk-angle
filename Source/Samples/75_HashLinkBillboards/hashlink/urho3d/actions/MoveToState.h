...
#ifndef INC_urho3d__actions__MoveToState
#define INC_urho3d__actions__MoveToState
typedef struct _urho3d__actions__$MoveToState *urho3d__actions__$MoveToState;
typedef struct _urho3d__actions__MoveToState *urho3d__actions__MoveToState;
#include <hl/Class.h>
...
struct _urho3d__actions__$MoveToState {
	hl_type *$type;
	hl_type* __type__;
	vdynamic* __meta__;
...
struct _urho3d__actions__MoveToState {
	hl_type *$type;
	bool firstTick;
	double Duration;
	double elapsed;
