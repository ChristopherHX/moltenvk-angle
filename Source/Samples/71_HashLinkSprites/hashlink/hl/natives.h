...
typedef struct _hl_urho3d_audio_sound hl_urho3d_audio_sound;
typedef struct _hl_urho3d_audio_sound_source hl_urho3d_audio_sound_source;
typedef struct _hl_urho3d_color hl_urho3d_color;
typedef struct _hl_urho3d_core_object hl_urho3d_core_object;
...
typedef struct _hl_urho3d_graphics_animation_controller hl_urho3d_graphics_animation_controller;
...
typedef struct _hl_urho3d_graphics_bone hl_urho3d_graphics_bone;
...
typedef struct _hl_urho3d_graphics_render_surface hl_urho3d_graphics_render_surface;
typedef struct _hl_urho3d_graphics_skeleton hl_urho3d_graphics_skeleton;
...
typedef struct _hl_urho3d_io_file hl_urho3d_io_file;
typedef struct _hl_urho3d_io_t_vector_buffer hl_urho3d_io_t_vector_buffer;
typedef struct _hl_urho3d_io_vector_buffer hl_urho3d_io_vector_buffer;
...
typedef struct _hl_urho3d_math_t_ray hl_urho3d_math_t_ray;
...
typedef struct _hl_urho3d_physics_constraint hl_urho3d_physics_constraint;
typedef struct _hl_urho3d_physics_physics_world hl_urho3d_physics_physics_world;
typedef struct _hl_urho3d_physics_raycast_result hl_urho3d_physics_raycast_result;
typedef struct _hl_urho3d_physics_rigid_body hl_urho3d_physics_rigid_body;
typedef struct _hl_urho3d_physics_t_rigid_body hl_urho3d_physics_t_rigid_body;
...
typedef struct _hl_urho3d_scene_component_ptr hl_urho3d_scene_component_ptr;
...
typedef struct _hl_urho3d_scene_node_ptr hl_urho3d_scene_node_ptr;
...
typedef struct _hl_urho3d_scene_t_node hl_urho3d_scene_t_node;
typedef struct _hl_urho3d_scene_value_animation hl_urho3d_scene_value_animation;
...
typedef struct _hl_urho3d_urho2d_particle_effect2d hl_urho3d_urho2d_particle_effect2d;
typedef struct _hl_urho3d_urho2d_particle_emitter2d hl_urho3d_urho2d_particle_emitter2d;
...
typedef struct _urho3d_refcounted urho3d_refcounted;

#include <hl/natives.h>
#include <_std/String.h>

// Natives functions
HL_API hl_urho3d_tvariantmap* Urho3D__application_get_engine_parameters(hl_urho3d_application*);
...
HL_API hl_urho3d_audio_sound* Urho3D__audio_sound_create(urho3d_context*,String);
HL_API vbyte* Urho3D__audio_sound_get_name(hl_urho3d_audio_sound*);
HL_API hl_urho3d_audio_sound_source* Urho3D__audio_sound_source_cast_from_component(urho3d_context*,hl_urho3d_scene_component*);
HL_API hl_urho3d_scene_component* Urho3D__audio_sound_source_cast_to_component(urho3d_context*,hl_urho3d_audio_sound_source*);
HL_API hl_urho3d_audio_sound_source* Urho3D__audio_sound_source_create(urho3d_context*);
HL_API int Urho3D__audio_sound_source_get_auto_remove(urho3d_context*,hl_urho3d_audio_sound_source*);
HL_API float Urho3D__audio_sound_source_get_gain(urho3d_context*,hl_urho3d_audio_sound_source*);
HL_API void Urho3D__audio_sound_source_play(urho3d_context*,hl_urho3d_audio_sound_source*,hl_urho3d_audio_sound*);
HL_API void Urho3D__audio_sound_source_set_auto_remove(urho3d_context*,hl_urho3d_audio_sound_source*,int);
HL_API void Urho3D__audio_sound_source_set_gain(urho3d_context*,hl_urho3d_audio_sound_source*,float);
HL_API hl_urho3d_uielement* Urho3D__cast_sprite_to_uielement(urho3d_context*,hl_urho3d_sprite*);
HL_API hl_urho3d_scene_t_node* Urho3D__container_refcounted_cast_to_t_node(urho3d_context*,urho3d_refcounted*);
HL_API hl_urho3d_physics_t_rigid_body* Urho3D__container_refcounted_cast_to_t_rigid_body(urho3d_context*,urho3d_refcounted*);
HL_API hl_urho3d_core_object* Urho3D__core_object_cast_from_component(urho3d_context*,hl_urho3d_scene_component*);
...
HL_API void Urho3D__core_variantmap_clear(hl_urho3d_variantmap*);
HL_API hl_urho3d_variantmap* Urho3D__core_variantmap_create(void);
HL_API hl_urho3d_tvariant* Urho3D__core_variantmap_get_key_string_value(hl_urho3d_variantmap*,String);
...
HL_API hl_urho3d_graphics_skeleton* Urho3D__graphics_animatedmodel_get_skeleton(urho3d_context*,hl_urho3d_graphics_animatedmodel*);
HL_API bool Urho3D__graphics_animatedmodel_get_update_invisible(urho3d_context*,hl_urho3d_graphics_animatedmodel*);
...
HL_API void Urho3D__graphics_animatedmodel_set_update_invisible(urho3d_context*,hl_urho3d_graphics_animatedmodel*,bool);
HL_API hl_urho3d_graphics_animation_controller* Urho3D__graphics_animation_controller_cast_from_component(urho3d_context*,hl_urho3d_scene_component*);
HL_API hl_urho3d_scene_component* Urho3D__graphics_animation_controller_cast_to_component(urho3d_context*,hl_urho3d_graphics_animation_controller*);
HL_API hl_urho3d_graphics_animation_controller* Urho3D__graphics_animation_controller_create(urho3d_context*);
HL_API float Urho3D__graphics_animation_controller_get_speed(urho3d_context*,hl_urho3d_graphics_animation_controller*,String);
HL_API bool Urho3D__graphics_animation_controller_play_exclusive(urho3d_context*,hl_urho3d_graphics_animation_controller*,String,int,bool,float);
HL_API bool Urho3D__graphics_animation_controller_set_speed(urho3d_context*,hl_urho3d_graphics_animation_controller*,String,float);
...
HL_API bool Urho3D__graphics_bone_get_animated(urho3d_context*,hl_urho3d_graphics_bone*);
HL_API void Urho3D__graphics_bone_set_animated(urho3d_context*,hl_urho3d_graphics_bone*,bool);
...
HL_API hl_urho3d_math_t_ray* Urho3D__graphics_camera_get_screen_ray(urho3d_context*,hl_urho3d_graphics_camera*,float,float);
...
HL_API float Urho3D__graphics_light_get_brightness(urho3d_context*,hl_urho3d_graphics_light*);
...
HL_API void Urho3D__graphics_light_set_brightness(urho3d_context*,hl_urho3d_graphics_light*,float);
...
HL_API hl_urho3d_graphics_material* Urho3D__graphics_material_clone(urho3d_context*,hl_urho3d_graphics_material*,String);
...
HL_API hl_urho3d_tvariant* Urho3D__graphics_material_get_shader_parameter(urho3d_context*,hl_urho3d_graphics_material*,String);
HL_API hl_urho3d_scene_value_animation* Urho3D__graphics_material_get_shader_parameter_animation(urho3d_context*,hl_urho3d_graphics_material*,String);
...
HL_API void Urho3D__graphics_material_set_shader_parameter(urho3d_context*,hl_urho3d_graphics_material*,String,hl_urho3d_tvariant*);
HL_API void Urho3D__graphics_material_set_shader_parameter_animation(urho3d_context*,hl_urho3d_graphics_material*,String,hl_urho3d_scene_value_animation*,int,float);
...
HL_API hl_urho3d_graphics_ray_query_results* Urho3D__graphics_octree_raycast_single(urho3d_context*,hl_urho3d_graphics_octree*,hl_urho3d_math_t_ray*,int,float,int,int);
...
HL_API hl_urho3d_graphics_render_surface* Urho3D__graphics_render_surface_create(urho3d_context*,hl_urho3d_graphics_texture*);
HL_API hl_urho3d_graphics_viewport* Urho3D__graphics_render_surface_get_viewport(urho3d_context*,hl_urho3d_graphics_render_surface*,int);
HL_API void Urho3D__graphics_render_surface_set_viewport(urho3d_context*,hl_urho3d_graphics_render_surface*,int,hl_urho3d_graphics_viewport*);
HL_API void Urho3D__graphics_render_toggle_enabled(urho3d_context*,hl_urho3d_graphics_render_path*,String);
HL_API hl_urho3d_graphics_bone* Urho3D__graphics_skeleton_get_bone(urho3d_context*,hl_urho3d_graphics_skeleton*,String);
...
HL_API hl_urho3d_texture2d* Urho3D__graphics_texture2d_cast_from_texture(urho3d_context*,hl_urho3d_graphics_texture*);
HL_API hl_urho3d_graphics_texture* Urho3D__graphics_texture2d_cast_to_texture(urho3d_context*,hl_urho3d_texture2d*);
HL_API hl_urho3d_texture2d* Urho3D__graphics_texture2d_create(urho3d_context*,String);
HL_API hl_urho3d_texture2d* Urho3D__graphics_texture2d_create_empty(urho3d_context*);
HL_API int Urho3D__graphics_texture2d_get_filter_mode(urho3d_context*,hl_urho3d_texture2d*);
HL_API vbyte* Urho3D__graphics_texture2d_get_name(hl_urho3d_texture2d*);
HL_API hl_urho3d_graphics_render_surface* Urho3D__graphics_texture2d_get_render_surface(urho3d_context*,hl_urho3d_texture2d*);
HL_API void Urho3D__graphics_texture2d_set_filter_mode(urho3d_context*,hl_urho3d_texture2d*,int);
HL_API bool Urho3D__graphics_texture2d_set_size(urho3d_context*,hl_urho3d_texture2d*,int,int,int,int,int,bool);
...
HL_API hl_urho3d_math_tvector3* Urho3D__graphics_viewport_screen_to_world_point(urho3d_context*,hl_urho3d_graphics_viewport*,int,int,float);
...
HL_API hl_urho3d_io_file* Urho3D__io_file_create(urho3d_context*,String,int);
HL_API hl_urho3d_io_t_vector_buffer* Urho3D__io_t_vector_buffer_cast_from_vector_buffer(hl_urho3d_io_vector_buffer*);
HL_API hl_urho3d_io_vector_buffer* Urho3D__io_t_vector_buffer_cast_to_vector_buffer(hl_urho3d_io_t_vector_buffer*);
HL_API hl_urho3d_io_t_vector_buffer* Urho3D__io_t_vector_buffer_create(void);
HL_API bool Urho3D__io_t_vector_buffer_is_eof(hl_urho3d_io_t_vector_buffer*);
HL_API bool Urho3D__io_t_vector_buffer_read_bool(hl_urho3d_io_t_vector_buffer*);
HL_API float Urho3D__io_t_vector_buffer_read_float(hl_urho3d_io_t_vector_buffer*);
HL_API int Urho3D__io_t_vector_buffer_read_int(hl_urho3d_io_t_vector_buffer*);
HL_API hl_urho3d_math_tvector2* Urho3D__io_t_vector_buffer_read_vector2(hl_urho3d_io_t_vector_buffer*);
HL_API hl_urho3d_math_tvector3* Urho3D__io_t_vector_buffer_read_vector3(hl_urho3d_io_t_vector_buffer*);
HL_API hl_urho3d_io_vector_buffer* Urho3D__io_vector_buffer_create(void);
...
HL_API void Urho3D__math_quaternion_normalize(hl_urho3d_math_quaternion*);
...
HL_API hl_urho3d_math_tquaternion* Urho3D__math_t_quaternion_cast_from_quaternion(hl_urho3d_math_quaternion*);
HL_API hl_urho3d_math_quaternion* Urho3D__math_t_quaternion_cast_to_quaternion(hl_urho3d_math_tquaternion*);
HL_API hl_urho3d_math_tquaternion* Urho3D__math_t_quaternion_create(float,float,float);
HL_API hl_urho3d_math_tquaternion* Urho3D__math_t_quaternion_create_fv(float,hl_urho3d_math_tvector3*);
HL_API hl_urho3d_math_tquaternion* Urho3D__math_t_quaternion_multiply_tquaternion(hl_urho3d_math_tquaternion*,hl_urho3d_math_tquaternion*);
HL_API hl_urho3d_math_tvector3* Urho3D__math_t_quaternion_multiply_tvector3(hl_urho3d_math_tquaternion*,hl_urho3d_math_tvector3*);
HL_API void Urho3D__math_t_quaternion_normalize(hl_urho3d_math_tquaternion*);
HL_API hl_urho3d_math_t_ray* Urho3D__math_t_ray_cast_from_ray(hl_urho3d_math_ray*);
HL_API hl_urho3d_math_ray* Urho3D__math_t_ray_cast_to_ray(hl_urho3d_math_t_ray*);
HL_API hl_urho3d_math_t_ray* Urho3D__math_t_ray_create(hl_urho3d_math_tvector3*,hl_urho3d_math_tvector3*);
...
HL_API void Urho3D__physics_collision_shape_set_capsule(urho3d_context*,hl_urho3d_physics_collision_shape*,float,float,hl_urho3d_math_tvector3*,hl_urho3d_math_tquaternion*);
HL_API void Urho3D__physics_collision_shape_set_cylinder(urho3d_context*,hl_urho3d_physics_collision_shape*,float,float,hl_urho3d_math_tvector3*,hl_urho3d_math_tquaternion*);
HL_API void Urho3D__physics_collision_shape_set_sphere(urho3d_context*,hl_urho3d_physics_collision_shape*,float,hl_urho3d_math_tvector3*,hl_urho3d_math_tquaternion*);
HL_API void Urho3D__physics_collision_shape_set_static_plane(urho3d_context*,hl_urho3d_physics_collision_shape*,hl_urho3d_math_tvector3*,hl_urho3d_math_tquaternion*);
HL_API void Urho3D__physics_collision_shape_set_triangle_mesh(urho3d_context*,hl_urho3d_physics_collision_shape*,hl_urho3d_graphics_model*,int,hl_urho3d_math_tvector3*,hl_urho3d_math_tvector3*,hl_urho3d_math_tquaternion*);
HL_API hl_urho3d_physics_constraint* Urho3D__physics_constraint_cast_from_component(urho3d_context*,hl_urho3d_scene_component*);
HL_API hl_urho3d_scene_component* Urho3D__physics_constraint_cast_to_component(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API hl_urho3d_physics_constraint* Urho3D__physics_constraint_create(urho3d_context*);
HL_API bool Urho3D__physics_constraint_get_disable_collision(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API hl_urho3d_math_tvector2* Urho3D__physics_constraint_get_high_limit(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API hl_urho3d_math_tvector2* Urho3D__physics_constraint_get_low_limit(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API hl_urho3d_physics_rigid_body* Urho3D__physics_constraint_get_other_body(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API int Urho3D__physics_constraint_get_type(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API hl_urho3d_math_tvector3* Urho3D__physics_constraint_get_world_position(urho3d_context*,hl_urho3d_physics_constraint*);
HL_API void Urho3D__physics_constraint_set_axis(urho3d_context*,hl_urho3d_physics_constraint*,hl_urho3d_math_tvector3*);
HL_API void Urho3D__physics_constraint_set_disable_collision(urho3d_context*,hl_urho3d_physics_constraint*,bool);
HL_API void Urho3D__physics_constraint_set_high_limit(urho3d_context*,hl_urho3d_physics_constraint*,hl_urho3d_math_tvector2*);
HL_API void Urho3D__physics_constraint_set_low_limit(urho3d_context*,hl_urho3d_physics_constraint*,hl_urho3d_math_tvector2*);
HL_API void Urho3D__physics_constraint_set_other_axis(urho3d_context*,hl_urho3d_physics_constraint*,hl_urho3d_math_tvector3*);
HL_API void Urho3D__physics_constraint_set_other_body(urho3d_context*,hl_urho3d_physics_constraint*,hl_urho3d_physics_rigid_body*);
HL_API void Urho3D__physics_constraint_set_type(urho3d_context*,hl_urho3d_physics_constraint*,int);
HL_API void Urho3D__physics_constraint_set_world_position(urho3d_context*,hl_urho3d_physics_constraint*,hl_urho3d_math_tvector3*);
HL_API hl_urho3d_physics_physics_world* Urho3D__physics_physics_world_cast_from_component(urho3d_context*,hl_urho3d_scene_component*);
HL_API hl_urho3d_scene_component* Urho3D__physics_physics_world_cast_to_component(urho3d_context*,hl_urho3d_physics_physics_world*);
HL_API hl_urho3d_math_tvector3* Urho3D__physics_physics_world_get_gravity(urho3d_context*,hl_urho3d_physics_physics_world*);
HL_API hl_urho3d_physics_raycast_result* Urho3D__physics_physics_world_raycast_single(urho3d_context*,hl_urho3d_physics_physics_world*,hl_urho3d_math_t_ray*,float,int);
HL_API void Urho3D__physics_physics_world_set_gravity(urho3d_context*,hl_urho3d_physics_physics_world*,hl_urho3d_math_tvector3*);
HL_API float Urho3D__physics_raycast_result_get_distance(hl_urho3d_physics_raycast_result*);
HL_API float Urho3D__physics_raycast_result_get_hit_friction(hl_urho3d_physics_raycast_result*);
HL_API hl_urho3d_math_tvector3* Urho3D__physics_raycast_result_get_normal(hl_urho3d_physics_raycast_result*);
HL_API hl_urho3d_math_tvector3* Urho3D__physics_raycast_result_get_position(hl_urho3d_physics_raycast_result*);
HL_API hl_urho3d_physics_t_rigid_body* Urho3D__physics_raycast_result_get_rigid_body(hl_urho3d_physics_raycast_result*);
HL_API void Urho3D__physics_rigid_body_apply_impulse(urho3d_context*,hl_urho3d_physics_rigid_body*,hl_urho3d_math_tvector3*,hl_urho3d_math_tvector3*);
...
HL_API hl_urho3d_math_tvector3* Urho3D__physics_rigid_body_get_angular_factor(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API float Urho3D__physics_rigid_body_get_angular_rest_threshold(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API int Urho3D__physics_rigid_body_get_collision_event_mode(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API int Urho3D__physics_rigid_body_get_collision_layer(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API int Urho3D__physics_rigid_body_get_collision_mask(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API float Urho3D__physics_rigid_body_get_friction(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API bool Urho3D__physics_rigid_body_get_kinematic(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API float Urho3D__physics_rigid_body_get_linear_dumping(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API float Urho3D__physics_rigid_body_get_linear_dumping(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API float Urho3D__physics_rigid_body_get_linear_rest_threshold(urho3d_context*,hl_urho3d_physics_rigid_body*);
...
HL_API float Urho3D__physics_rigid_body_get_rolling_friction(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API bool Urho3D__physics_rigid_body_get_trigger(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API void Urho3D__physics_rigid_body_set_angular_dumping(urho3d_context*,hl_urho3d_physics_rigid_body*,float);
HL_API void Urho3D__physics_rigid_body_set_angular_factor(urho3d_context*,hl_urho3d_physics_rigid_body*,hl_urho3d_math_tvector3*);
HL_API void Urho3D__physics_rigid_body_set_angular_rest_threshold(urho3d_context*,hl_urho3d_physics_rigid_body*,float);
HL_API void Urho3D__physics_rigid_body_set_collision_event_mode(urho3d_context*,hl_urho3d_physics_rigid_body*,int);
HL_API void Urho3D__physics_rigid_body_set_collision_layer(urho3d_context*,hl_urho3d_physics_rigid_body*,int);
HL_API void Urho3D__physics_rigid_body_set_collision_mask(urho3d_context*,hl_urho3d_physics_rigid_body*,int);
HL_API void Urho3D__physics_rigid_body_set_friction(urho3d_context*,hl_urho3d_physics_rigid_body*,float);
HL_API void Urho3D__physics_rigid_body_set_kinematic(urho3d_context*,hl_urho3d_physics_rigid_body*,bool);
HL_API void Urho3D__physics_rigid_body_set_linear_dumping(urho3d_context*,hl_urho3d_physics_rigid_body*,float);
HL_API void Urho3D__physics_rigid_body_set_linear_rest_threshold(urho3d_context*,hl_urho3d_physics_rigid_body*,float);
...
HL_API void Urho3D__physics_rigid_body_set_rolling_friction(urho3d_context*,hl_urho3d_physics_rigid_body*,float);
HL_API void Urho3D__physics_rigid_body_set_trigger(urho3d_context*,hl_urho3d_physics_rigid_body*,bool);
HL_API void Urho3D__physics_t_rigid_body_apply_impulse(urho3d_context*,hl_urho3d_physics_t_rigid_body*,hl_urho3d_math_tvector3*,hl_urho3d_math_tvector3*);
HL_API hl_urho3d_physics_t_rigid_body* Urho3D__physics_t_rigid_body_cast_from_rigid_body(urho3d_context*,hl_urho3d_physics_rigid_body*);
HL_API hl_urho3d_physics_rigid_body* Urho3D__physics_t_rigid_body_cast_to_rigid_body(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API hl_urho3d_math_tvector3* Urho3D__physics_t_rigid_body_get_angular_factor(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_angular_rest_threshold(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API int Urho3D__physics_t_rigid_body_get_collision_event_mode(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API int Urho3D__physics_t_rigid_body_get_collision_layer(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API int Urho3D__physics_t_rigid_body_get_collision_mask(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_friction(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API bool Urho3D__physics_t_rigid_body_get_kinematic(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_linear_dumping(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_linear_dumping(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_linear_rest_threshold(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API hl_urho3d_math_tvector3* Urho3D__physics_t_rigid_body_get_linear_velocity(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_mass(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API float Urho3D__physics_t_rigid_body_get_rolling_friction(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API bool Urho3D__physics_t_rigid_body_get_trigger(urho3d_context*,hl_urho3d_physics_t_rigid_body*);
HL_API void Urho3D__physics_t_rigid_body_set_angular_dumping(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_angular_factor(urho3d_context*,hl_urho3d_physics_t_rigid_body*,hl_urho3d_math_tvector3*);
HL_API void Urho3D__physics_t_rigid_body_set_angular_rest_threshold(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_collision_event_mode(urho3d_context*,hl_urho3d_physics_t_rigid_body*,int);
HL_API void Urho3D__physics_t_rigid_body_set_collision_layer(urho3d_context*,hl_urho3d_physics_t_rigid_body*,int);
HL_API void Urho3D__physics_t_rigid_body_set_collision_mask(urho3d_context*,hl_urho3d_physics_t_rigid_body*,int);
HL_API void Urho3D__physics_t_rigid_body_set_friction(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_kinematic(urho3d_context*,hl_urho3d_physics_t_rigid_body*,bool);
HL_API void Urho3D__physics_t_rigid_body_set_linear_dumping(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_linear_rest_threshold(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_linear_velocity(urho3d_context*,hl_urho3d_physics_t_rigid_body*,hl_urho3d_math_tvector3*);
HL_API void Urho3D__physics_t_rigid_body_set_mass(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_rolling_friction(urho3d_context*,hl_urho3d_physics_t_rigid_body*,float);
HL_API void Urho3D__physics_t_rigid_body_set_trigger(urho3d_context*,hl_urho3d_physics_t_rigid_body*,bool);
...
HL_API hl_urho3d_scene_component_ptr* Urho3D__scene_component_get_component_pointer(urho3d_context*,hl_urho3d_scene_component*);
HL_API bool Urho3D__scene_component_get_enabled(urho3d_context*,hl_urho3d_scene_component*);
HL_API hl_urho3d_scene_node* Urho3D__scene_component_get_node(urho3d_context*,hl_urho3d_scene_component*);
HL_API hl_urho3d_scene_scene* Urho3D__scene_component_get_scene(urho3d_context*,hl_urho3d_scene_component*);
HL_API void Urho3D__scene_component_set_enabled(urho3d_context*,hl_urho3d_scene_component*,bool);
...
HL_API void Urho3D__scene_component_subscribe_to_event_sender(urho3d_context*,hl_urho3d_core_object*,hl_urho3d_scene_component*,hl_urho3d_stringhash*,vdynamic*,String);
...
HL_API hl_urho3d_scene_logic_component* Urho3D__scene_logic_component_create(urho3d_context*,vdynamic*,String);
HL_API vbyte* Urho3D__scene_logic_component_get_class_name(urho3d_context*,hl_urho3d_scene_logic_component*);
HL_API int Urho3D__scene_logic_component_get_update_event_mask(urho3d_context*,hl_urho3d_scene_logic_component*);
HL_API void Urho3D__scene_logic_component_register_object(urho3d_context*);
HL_API void Urho3D__scene_logic_component_set_update_event_mask(urho3d_context*,hl_urho3d_scene_logic_component*,int);
HL_API void Urho3D__scene_node_add_component(urho3d_context*,hl_urho3d_scene_node*,hl_urho3d_scene_component*,int,int);
HL_API hl_urho3d_scene_node* Urho3D__scene_node_clone(urho3d_context*,hl_urho3d_scene_node*);
...
HL_API varray* Urho3D__scene_node_get_all_logic_components(urho3d_context*,hl_urho3d_scene_node*,bool);
HL_API hl_urho3d_scene_node* Urho3D__scene_node_get_child(urho3d_context*,hl_urho3d_scene_node*,String,bool);
...
HL_API bool Urho3D__scene_node_get_enabled(urho3d_context*,hl_urho3d_scene_node*);
HL_API hl_urho3d_scene_node* Urho3D__scene_node_get_from_pod_vector(urho3d_context*,hl_urho3d_scene_pod_node*,int);
HL_API vdynamic* Urho3D__scene_node_get_logic_component(urho3d_context*,hl_urho3d_scene_node*,String,bool);
HL_API varray* Urho3D__scene_node_get_logic_components(urho3d_context*,hl_urho3d_scene_node*,String,bool);
HL_API vbyte* Urho3D__scene_node_get_name(urho3d_context*,hl_urho3d_scene_node*);
HL_API hl_urho3d_scene_node_ptr* Urho3D__scene_node_get_node_pointer(urho3d_context*,hl_urho3d_scene_node*);
HL_API hl_urho3d_scene_node* Urho3D__scene_node_get_parent(urho3d_context*,hl_urho3d_scene_node*);
...
HL_API hl_urho3d_tvariantmap* Urho3D__scene_node_get_vars(urho3d_context*,hl_urho3d_scene_node*);
HL_API hl_urho3d_math_tvector3* Urho3D__scene_node_get_world_position(urho3d_context*,hl_urho3d_scene_node*);
HL_API bool Urho3D__scene_node_look_at(urho3d_context*,hl_urho3d_scene_node*,hl_urho3d_math_tvector3*,hl_urho3d_math_tvector3*,int);
HL_API void Urho3D__scene_node_pitch(urho3d_context*,hl_urho3d_scene_node*,float,int);
HL_API void Urho3D__scene_node_remove(urho3d_context*,hl_urho3d_scene_node*);
HL_API void Urho3D__scene_node_remove_child(urho3d_context*,hl_urho3d_scene_node*,hl_urho3d_scene_node*);
HL_API void Urho3D__scene_node_remove_component(urho3d_context*,hl_urho3d_scene_node*,hl_urho3d_scene_component*);
HL_API void Urho3D__scene_node_remove_component_string(urho3d_context*,hl_urho3d_scene_node*,String);
...
HL_API void Urho3D__scene_node_rotate_around(urho3d_context*,hl_urho3d_scene_node*,hl_urho3d_math_tvector3*,hl_urho3d_math_tquaternion*,int);
...
HL_API void Urho3D__scene_node_set_dynamic(urho3d_context*,hl_urho3d_scene_node*,vdynamic*);
HL_API void Urho3D__scene_node_set_enabled(urho3d_context*,hl_urho3d_scene_node*,bool);
...
HL_API void Urho3D__scene_node_set_world_position(urho3d_context*,hl_urho3d_scene_node*,hl_urho3d_math_tvector3*);
...
HL_API void Urho3D__scene_node_subscribe_to_event_sender(urho3d_context*,hl_urho3d_core_object*,hl_urho3d_scene_node*,hl_urho3d_stringhash*,vdynamic*,String);
...
HL_API hl_urho3d_scene_scene* Urho3D__scene_scene_create(urho3d_context*,vdynamic*);
HL_API hl_urho3d_graphics_octree* Urho3D__scene_scene_get_octree(urho3d_context*,hl_urho3d_scene_scene*);
HL_API hl_urho3d_physics_physics_world* Urho3D__scene_scene_get_physics_world(urho3d_context*,hl_urho3d_scene_scene*);
HL_API bool Urho3D__scene_scene_load_xml(urho3d_context*,hl_urho3d_scene_scene*,hl_urho3d_io_file*);
HL_API bool Urho3D__scene_scene_load_xml_string(urho3d_context*,hl_urho3d_scene_scene*,String);
HL_API bool Urho3D__scene_scene_save_xml(urho3d_context*,hl_urho3d_scene_scene*,hl_urho3d_io_file*,String);
HL_API bool Urho3D__scene_scene_save_xml_string(urho3d_context*,hl_urho3d_scene_scene*,String,String);
HL_API hl_urho3d_scene_t_node* Urho3D__scene_t_node_cast_from_node(urho3d_context*,hl_urho3d_scene_node*);
HL_API hl_urho3d_scene_node* Urho3D__scene_t_node_cast_to_node(urho3d_context*,hl_urho3d_scene_t_node*);
HL_API hl_urho3d_scene_value_animation* Urho3D__scene_value_animation_create(urho3d_context*);
HL_API bool Urho3D__scene_value_animation_set_keyframe(urho3d_context*,hl_urho3d_scene_value_animation*,float,hl_urho3d_tvariant*);
...
HL_API hl_urho3d_graphics_texture* Urho3D__sprite_get_texture(urho3d_context*,hl_urho3d_sprite*);
...
HL_API hl_urho3d_graphics_texture* Urho3D__sprite_set_texture(urho3d_context*,hl_urho3d_sprite*,hl_urho3d_graphics_texture*);
...
HL_API urho3d_refcounted* Urho3D__t_variant_get_pointer(hl_urho3d_tvariant*);
HL_API vbyte* Urho3D__t_variant_get_string(hl_urho3d_tvariant*);
HL_API hl_urho3d_io_t_vector_buffer* Urho3D__t_variant_get_vector_buffer(hl_urho3d_tvariant*);
HL_API void Urho3D__t_variant_set_string(hl_urho3d_tvariant*,String);
HL_API void Urho3D__t_variant_set_vector_buffer(hl_urho3d_tvariant*,hl_urho3d_io_t_vector_buffer*);
HL_API bool Urho3D__tvariant_get_bool(hl_urho3d_tvariant*);
HL_API float Urho3D__tvariant_get_float(hl_urho3d_tvariant*);
HL_API int Urho3D__tvariant_get_int(hl_urho3d_tvariant*);
HL_API hl_urho3d_core_object* Urho3D__tvariant_get_object(hl_urho3d_tvariant*);
HL_API hl_urho3d_tcolor* Urho3D__tvariant_get_t_color(hl_urho3d_tvariant*);
...
HL_API void Urho3D__tvariant_set_bool(hl_urho3d_tvariant*,bool);
...
HL_API void Urho3D__tvariant_set_object(hl_urho3d_tvariant*,hl_urho3d_core_object*);
HL_API void Urho3D__tvariant_set_t_color(hl_urho3d_tvariant*,hl_urho3d_tcolor*);
...
HL_API hl_urho3d_scene_component* Urho3D__urho2d_particle_emitter2d_cast_to_component(urho3d_context*,hl_urho3d_urho2d_particle_emitter2d*);
HL_API hl_urho3d_urho2d_particle_emitter2d* Urho3D__urho2d_particle_emitter2d_create(urho3d_context*);
HL_API hl_urho3d_urho2d_particle_effect2d* Urho3D__urho2d_particle_emitter2d_get_effect(urho3d_context*,hl_urho3d_urho2d_particle_emitter2d*);
HL_API void Urho3D__urho2d_particle_emitter2d_set_effect(urho3d_context*,hl_urho3d_urho2d_particle_emitter2d*,hl_urho3d_urho2d_particle_effect2d*);
HL_API bool Urho3D__variant_get_bool(hl_urho3d_variant*);
HL_API float Urho3D__variant_get_float(hl_urho3d_variant*);
HL_API int Urho3D__variant_get_int(hl_urho3d_variant*);
HL_API hl_urho3d_core_object* Urho3D__variant_get_object(hl_urho3d_variant*);
HL_API urho3d_refcounted* Urho3D__variant_get_pointer(hl_urho3d_variant*);
HL_API vbyte* Urho3D__variant_get_string(hl_urho3d_variant*);
...
HL_API void Urho3D__variant_set_bool(hl_urho3d_variant*,bool);
HL_API void Urho3D__variant_set_float(hl_urho3d_variant*,float);
HL_API void Urho3D__variant_set_int(hl_urho3d_variant*,int);
HL_API void Urho3D__variant_set_object(hl_urho3d_variant*,hl_urho3d_core_object*);
HL_API void Urho3D__variant_set_string(hl_urho3d_variant*,String);
