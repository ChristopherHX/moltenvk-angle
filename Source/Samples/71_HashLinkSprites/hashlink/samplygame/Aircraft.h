...
#ifndef INC_samplygame__Aircraft
#define INC_samplygame__Aircraft
typedef struct _samplygame__$Aircraft *samplygame__$Aircraft;
typedef struct _samplygame__Aircraft *samplygame__Aircraft;
#include <hl/Class.h>
