...
#ifndef INC_samplygame__Enemy
#define INC_samplygame__Enemy
typedef struct _samplygame__$Enemy *samplygame__$Enemy;
typedef struct _samplygame__Enemy *samplygame__Enemy;
#include <hl/Class.h>
