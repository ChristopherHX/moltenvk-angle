...
urho3d_refcounted* urho3d__Variant_Variant_Impl__GetPtr(hl_urho3d_variant* r0) {
	urho3d_refcounted *r1;
	r1 = Urho3D__variant_get_pointer(r0);
	return r1;
}

urho3d__Node urho3d__Variant_Variant_Impl__GetNode(hl_urho3d_variant* r0) {
...
urho3d__RigidBody urho3d__Variant_Variant_Impl__GetRigidBody(hl_urho3d_variant* r0) {
	...
	if( !r3 ) goto label$bb80348_4_14;
	r5 = (urho3d___Context__$Context_Impl_)g$_urho3d__Context_Context_Impl_;
	r4 = r5->context;
	r6 = Urho3D__physics_rigid_body_cast_from_component(r4,r3);
	if( !r6 ) goto label$bb80348_4_12;
...
bool urho3d__Variant_Variant_Impl__GetBool(hl_urho3d_variant* r0) {
	bool r1;
	r1 = Urho3D__variant_get_bool(r0);
	return r1;
}
...
String urho3d__Variant_Variant_Impl__GetString(hl_urho3d_variant* r0) {
	String r2;
	int r3;
	vbyte *r1;
	r1 = Urho3D__variant_get_string(r0);
...
hl_urho3d_variant* urho3d__Variant_Variant_Impl__fromString(String r0) {
	hl_urho3d_variant *r1;
	r1 = Urho3D__create_variant();
	Urho3D__variant_set_string(r1,r0);
	return r1;
}
...
hl_urho3d_variant* urho3d__Variant_Variant_Impl__fromBool(bool r0) {
	hl_urho3d_variant *r1;
	r1 = Urho3D__create_variant();
	Urho3D__variant_set_bool(r1,r0);
	return r1;
}
