...
String hl_types_ArrayBytes_hl_UI16_join(hl__types__ArrayBytes_hl_UI16 r0,String r1) {
	...
	r5 = r0->length;
	label$039cf2f_2_4:
	if( r4 >= r5 ) goto label$039cf2f_2_21;
	r6 = r4;
	++r4;
	r8 = 0;
	if( r8 >= r6 ) goto label$039cf2f_2_12;
...
vdynamic* hl_types_ArrayBytes_hl_UI16_pop(hl__types__ArrayBytes_hl_UI16 r0) {
	...
	r1 = r0->length;
	r2 = 0;
	if( r1 != r2 ) goto label$039cf2f_3_5;
	r3 = NULL;
	return r3;
	label$039cf2f_3_5:
	r1 = r0->length;
...
int hl_types_ArrayBytes_hl_UI16_push(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1) {
	...
	r2 = r0->length;
	r4 = r0->size;
	if( r4 != r2 ) goto label$039cf2f_4_5;
	hl_types_ArrayBytes_hl_UI16___expand(r0,r2);
	goto label$039cf2f_4_8;
	label$039cf2f_4_5:
	r4 = r0->length;
	++r4;
	r0->length = r4;
...
void hl_types_ArrayBytes_hl_UI16_reverse(hl__types__ArrayBytes_hl_UI16 r0) {
	...
	r3 = r3 >> r4;
	label$039cf2f_5_4:
	if( r1 >= r3 ) goto label$039cf2f_5_33;
	r4 = r1;
	++r1;
	r5 = r0->length;
	r6 = 1;
...
vdynamic* hl_types_ArrayBytes_hl_UI16_shift(hl__types__ArrayBytes_hl_UI16 r0) {
	...
	r2 = r0->length;
	r3 = 0;
	if( r2 != r3 ) goto label$039cf2f_6_5;
	r4 = NULL;
	return r4;
	label$039cf2f_6_5:
	r5 = r0->bytes;
...
void hl_types_ArrayBytes_hl_UI16_blit(hl__types__ArrayBytes_hl_UI16 r0,int r1,hl__types__ArrayAccess r2,int r3,int r4) {
	...
	r8 = 0;
	if( r1 < r8 ) goto label$039cf2f_7_14;
	r8 = 0;
	if( r3 < r8 ) goto label$039cf2f_7_14;
	r8 = 0;
	if( r4 < r8 ) goto label$039cf2f_7_14;
	r7 = r1 + r4;
	r8 = r0->length;
	if( r8 < r7 ) goto label$039cf2f_7_14;
	r7 = r3 + r4;
	if( r5 == NULL ) hl_null_access();
	r8 = r5->length;
	if( r8 >= r7 ) goto label$039cf2f_7_17;
	label$039cf2f_7_14:
...
hl__types__ArrayBase hl_types_ArrayBytes_hl_UI16_slice(hl__types__ArrayBytes_hl_UI16 r0,int r1,vdynamic* r2) {
	...
	r5 = 0;
	if( r1 >= r5 ) goto label$039cf2f_8_9;
	r4 = r0->length;
	r4 = r4 + r1;
	r1 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$039cf2f_8_9;
	r4 = 0;
	r1 = r4;
	label$039cf2f_8_9:
	if( r2 ) goto label$039cf2f_8_12;
	r5 = r0->length;
	goto label$039cf2f_8_20;
	label$039cf2f_8_12:
	r5 = r2 ? r2->v.i : 0;
	r6 = 0;
	if( r5 >= r6 ) goto label$039cf2f_8_17;
	r6 = r0->length;
	r5 = r5 + r6;
	label$039cf2f_8_17:
	r6 = r0->length;
	if( r6 >= r5 ) goto label$039cf2f_8_20;
	r5 = r0->length;
	label$039cf2f_8_20:
	r5 = r5 - r1;
	r7 = 0;
	if( r5 >= r7 ) goto label$039cf2f_8_26;
...
void hl_types_ArrayBytes_hl_UI16_sort(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	r3 = &t$_ui16;
	r4 = &t$_i32;
	if( hl_same_type(r3,r4) != 0 ) {} else goto label$039cf2f_9_12;
	r5 = r0->bytes;
	r6 = 0;
	r7 = r0->length;
	if( r1 ) goto label$039cf2f_9_9;
	r8 = NULL;
	goto label$039cf2f_9_10;
	label$039cf2f_9_9:
	r8 = hl_alloc_closure_ptr(&t$fun_f38af0d,hl_types_ArrayBytes_hl_UI16_sort__$1,r1);
	label$039cf2f_9_10:
	hl_bsort_i32(r5,r6,r7,r8);
	goto label$039cf2f_9_20;
	label$039cf2f_9_12:
	r5 = r0->bytes;
	r6 = 0;
	r7 = r0->length;
	if( r1 ) goto label$039cf2f_9_18;
	r9 = NULL;
	goto label$039cf2f_9_19;
	label$039cf2f_9_18:
...
hl__types__ArrayBase hl_types_ArrayBytes_hl_UI16_splice(hl__types__ArrayBytes_hl_UI16 r0,int r1,int r2) {
	...
	r5 = 0;
	if( r2 >= r5 ) goto label$039cf2f_10_5;
	...
	label$039cf2f_10_5:
	r5 = 0;
	if( r1 >= r5 ) goto label$039cf2f_10_14;
	r4 = r0->length;
	r4 = r4 + r1;
	r1 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$039cf2f_10_14;
	r4 = 0;
	r1 = r4;
	label$039cf2f_10_14:
	r5 = r0->length;
	if( r5 >= r1 ) goto label$039cf2f_10_21;
	r4 = 0;
	r1 = r4;
	r4 = 0;
	r2 = r4;
	goto label$039cf2f_10_31;
	label$039cf2f_10_21:
	r4 = r1 + r2;
	r5 = r0->length;
	if( r5 >= r4 ) goto label$039cf2f_10_31;
	r4 = r0->length;
	r4 = r4 - r1;
	r2 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$039cf2f_10_31;
	r4 = 0;
	r2 = r4;
	label$039cf2f_10_31:
	r5 = 0;
	if( r2 != r5 ) goto label$039cf2f_10_36;
	r6 = (hl__types__ArrayBytes_hl_UI16)hl_alloc_obj(&t$hl_types_ArrayBytes_hl_UI16);
	hl_types_ArrayBytes_hl_UI16_new(r6);
	return ((hl__types__ArrayBase)r6);
	label$039cf2f_10_36:
...
String hl_types_ArrayBytes_hl_UI16_toString(hl__types__ArrayBytes_hl_UI16 r0) {
	...
	r4 = r0->length;
	label$039cf2f_11_6:
	if( r3 >= r4 ) goto label$039cf2f_11_24;
	r5 = r3;
	++r3;
	r7 = 0;
	if( r7 >= r5 ) goto label$039cf2f_11_15;
	if( r1 == NULL ) hl_null_access();
	r6 = 44;
...
void hl_types_ArrayBytes_hl_UI16_unshift(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1) {
	...
	r3 = r0->length;
	r4 = r0->size;
	if( r3 != r4 ) goto label$039cf2f_12_6;
	r3 = r0->length;
	hl_types_ArrayBytes_hl_UI16___expand(r0,r3);
	goto label$039cf2f_12_9;
	label$039cf2f_12_6:
	r3 = r0->length;
	++r3;
	r0->length = r3;
...
void hl_types_ArrayBytes_hl_UI16_insert(hl__types__ArrayBytes_hl_UI16 r0,int r1,unsigned short r2) {
	...
	r5 = 0;
	if( r1 >= r5 ) goto label$039cf2f_13_10;
	r4 = r0->length;
	r4 = r4 + r1;
	r1 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$039cf2f_13_9;
	r4 = 0;
	r1 = r4;
	label$039cf2f_13_9:
	goto label$039cf2f_13_14;
	label$039cf2f_13_10:
	r5 = r0->length;
	if( r5 >= r1 ) goto label$039cf2f_13_14;
	r4 = r0->length;
	r1 = r4;
	label$039cf2f_13_14:
	r4 = r0->length;
	r5 = r0->size;
	if( r4 != r5 ) goto label$039cf2f_13_20;
	r4 = r0->length;
	hl_types_ArrayBytes_hl_UI16___expand(r0,r4);
	goto label$039cf2f_13_23;
	label$039cf2f_13_20:
	r4 = r0->length;
	++r4;
	r0->length = r4;
...
bool hl_types_ArrayBytes_hl_UI16_contains(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1) {
	...
	r5 = -1;
	if( r3 != r5 ) goto label$039cf2f_14_6;
	r2 = false;
	goto label$039cf2f_14_7;
	label$039cf2f_14_6:
	r2 = true;
	label$039cf2f_14_7:
	return r2;
...
bool hl_types_ArrayBytes_hl_UI16_remove(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1) {
	...
	r6 = 0;
	if( r2 >= r6 ) goto label$039cf2f_15_6;
	r7 = false;
	return r7;
	label$039cf2f_15_6:
	r5 = r0->length;
...
int hl_types_ArrayBytes_hl_UI16_indexOf(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1,vdynamic* r2) {
	...
	if( r2 ) goto label$039cf2f_16_3;
	r3 = 0;
	goto label$039cf2f_16_4;
	label$039cf2f_16_3:
	r3 = r2 ? r2->v.i : 0;
	label$039cf2f_16_4:
	r5 = 0;
	if( r3 >= r5 ) goto label$039cf2f_16_13;
	r5 = r0->length;
	r4 = r3 + r5;
	r3 = r4;
	r5 = 0;
	if( r4 >= r5 ) goto label$039cf2f_16_13;
	r4 = 0;
	r3 = r4;
	label$039cf2f_16_13:
	r4 = r3;
	r5 = r0->length;
	label$039cf2f_16_15:
	if( r4 >= r5 ) goto label$039cf2f_16_27;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 1;
	...
	r10 = (int)r7;
	if( r10 != r1 ) goto label$039cf2f_16_26;
	return r6;
	label$039cf2f_16_26:
	goto label$039cf2f_16_15;
	label$039cf2f_16_27:
	r4 = -1;
	return r4;
}
...
int hl_types_ArrayBytes_hl_UI16_lastIndexOf(hl__types__ArrayBytes_hl_UI16 r0,unsigned short r1,vdynamic* r2) {
	...
	int r3, r4, r5, r6;
	r3 = r0->length;
	if( !r2 ) goto label$039cf2f_17_4;
	r4 = r2 ? r2->v.i : 0;
	goto label$039cf2f_17_6;
	label$039cf2f_17_4:
	r5 = 1;
	r4 = r3 - r5;
	label$039cf2f_17_6:
	if( r4 < r3 ) goto label$039cf2f_17_11;
	r6 = 1;
	r5 = r3 - r6;
	r4 = r5;
	goto label$039cf2f_17_15;
	label$039cf2f_17_11:
	r6 = 0;
	if( r4 >= r6 ) goto label$039cf2f_17_15;
	r5 = r4 + r3;
	r4 = r5;
	label$039cf2f_17_15:
	r6 = 0;
	if( r4 < r6 ) goto label$039cf2f_17_27;
	r7 = r0->bytes;
	r6 = 1;
	r6 = r4 << r6;
	r5 = *(unsigned short*)(r7 + r6);
	r8 = (int)r5;
	if( r8 != r1 ) goto label$039cf2f_17_25;
	return r4;
	label$039cf2f_17_25:
	--r4;
	goto label$039cf2f_17_15;
...
hl__types__ArrayDyn hl_types_ArrayBytes_hl_UI16_map(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	r4 = r0->length;
	r5 = 0;
	if( r5 >= r4 ) goto label$039cf2f_21_9;
	r4 = r0->length;
	r5 = 1;
	r4 = r4 - r5;
	...
	r5 = r0->length;
	label$039cf2f_21_11:
	if( r4 >= r5 ) goto label$039cf2f_21_26;
	r6 = r4;
	++r4;
	if( r2 == NULL ) hl_null_access();
	r8 = r2->array;
...
hl__types__ArrayBytes_hl_UI16 hl_types_ArrayBytes_hl_UI16_filter(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	...
	r5 = r0->length;
	label$039cf2f_22_4:
	if( r4 >= r5 ) goto label$039cf2f_22_19;
	r6 = r4;
	++r4;
	r8 = r0->bytes;
	r9 = 1;
	...
	if( !r11 ) goto label$039cf2f_22_18;
	if( r2 == NULL ) hl_null_access();
	r7 = hl_types_ArrayBytes_hl_UI16_push(r2,r10);
	label$039cf2f_22_18:
	goto label$039cf2f_22_4;
	label$039cf2f_22_19:
	return r2;
}
...
void hl_types_ArrayBytes_hl_UI16_resize(hl__types__ArrayBytes_hl_UI16 r0,int r1) {
	...
	int r3, r4, r8, r9;
	r3 = r0->length;
	if( r3 >= r1 ) goto label$039cf2f_23_6;
	r4 = 1;
	r3 = r1 - r4;
	hl_types_ArrayBytes_hl_UI16___expand(r0,r3);
	goto label$039cf2f_23_20;
	label$039cf2f_23_6:
	r3 = r0->length;
	if( r1 >= r3 ) goto label$039cf2f_23_20;
	r5 = r0->bytes;
	r6 = r0->bytes;
	r4 = 1;
	r3 = r1 << r4;
...
vdynamic* hl_types_ArrayBytes_hl_UI16_getDyn(hl__types__ArrayBytes_hl_UI16 r0,int r1) {
	...
	int r2, r3;
	r3 = r0->length;
	if( r1 < r3 ) goto label$039cf2f_24_6;
	r4 = r0->bytes;
	r5 = 0;
...
void hl_types_ArrayBytes_hl_UI16_setDyn(hl__types__ArrayBytes_hl_UI16 r0,int r1,vdynamic* r2) {
	...
	int r4, r7;
	r4 = r0->length;
	if( r1 < r4 ) goto label$039cf2f_25_3;
...
void hl_types_ArrayBytes_hl_UI16_sortDyn(hl__types__ArrayBytes_hl_UI16 r0,vclosure* r1) {
	vclosure *r3;
	if( r1 ) goto label$039cf2f_33_3;
	r3 = NULL;
	goto label$039cf2f_33_4;
	label$039cf2f_33_3:
...
void hl_types_ArrayBytes_hl_UI16___expand(hl__types__ArrayBytes_hl_UI16 r0,int r1) {
	...
	r4 = 0;
	if( r1 >= r4 ) goto label$039cf2f_34_10;
	...
	r3 = r1 + r4;
	r10 = r0->size;
	if( r10 >= r3 ) goto label$039cf2f_34_41;
	r4 = r0->size;
	r10 = 3;
	r4 = r4 * r10;
	r10 = 1;
	r4 = r4 >> r10;
	if( r4 >= r3 ) goto label$039cf2f_34_21;
	r4 = r3;
	label$039cf2f_34_21:
	r8 = r0->bytes;
	r11 = 1;
