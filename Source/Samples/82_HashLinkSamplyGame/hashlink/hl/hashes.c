...
void hl_init_hashes() {
	...
	hl_hash((vbyte*)USTR("gameNode"));
	hl_hash((vbyte*)USTR("cameraNode"));
	hl_hash((vbyte*)USTR("playing"));
	hl_hash((vbyte*)USTR("enemies_"));
	hl_hash((vbyte*)USTR("player_"));
	hl_hash((vbyte*)USTR("startMenu_"));
	hl_hash((vbyte*)USTR("startMenuNode_"));
	hl_hash((vbyte*)USTR("coins"));
	hl_hash((vbyte*)USTR("CoinsString"));
	hl_hash((vbyte*)USTR("HealthString"));
	hl_hash((vbyte*)USTR("coinsText"));
	hl_hash((vbyte*)USTR("healthText"));
	...
	hl_hash((vbyte*)USTR("CreateStartMenu"));
	hl_hash((vbyte*)USTR("DeleteStartMenu"));
	hl_hash((vbyte*)USTR("SpawnCoins"));
	hl_hash((vbyte*)USTR("SpawnCoinsLoop"));
	hl_hash((vbyte*)USTR("OnCoinCollected"));
	hl_hash((vbyte*)USTR("OnPlayerHealthUpdate"));
	...
	hl_hash((vbyte*)USTR("spawnInterval"));
	hl_hash((vbyte*)USTR("spawnIntervalThreshold"));
	hl_hash((vbyte*)USTR("SetPlayer"));
	hl_hash((vbyte*)USTR("RemovePlayer"));
	hl_hash((vbyte*)USTR("CreateObject"));
	hl_hash((vbyte*)USTR("StartDelayedPlay"));
	hl_hash((vbyte*)USTR("CreateEnemyMonitorScreenObject"));
	hl_hash((vbyte*)USTR("KillAll"));
	hl_hash((vbyte*)USTR("spawnNext"));
	hl_hash((vbyte*)USTR("StartSpawning"));
	hl_hash((vbyte*)USTR("Health"));
	hl_hash((vbyte*)USTR("MaxHealth"));
	hl_hash((vbyte*)USTR("level"));
	hl_hash((vbyte*)USTR("CollisionLayer"));
	hl_hash((vbyte*)USTR("CollisionShapeSize"));
	hl_hash((vbyte*)USTR("name"));
	hl_hash((vbyte*)USTR("IsAlive"));
	hl_hash((vbyte*)USTR("Play"));
	hl_hash((vbyte*)USTR("Init"));
	hl_hash((vbyte*)USTR("HandleNodeCollision"));
	hl_hash((vbyte*)USTR("SendHealthUpdateToSamplyGame"));
	hl_hash((vbyte*)USTR("Hit"));
	hl_hash((vbyte*)USTR("Explode"));
	hl_hash((vbyte*)USTR("OnExplode"));
	hl_hash((vbyte*)USTR("ExplodeDone"));
	hl_hash((vbyte*)USTR("DisableNode"));
	hl_hash((vbyte*)USTR("rotor"));
	hl_hash((vbyte*)USTR("actionID"));
	hl_hash((vbyte*)USTR("offsetY"));
	hl_hash((vbyte*)USTR("MoveRandomly"));
	hl_hash((vbyte*)USTR("RandmoMoveDone"));
	hl_hash((vbyte*)USTR("_action"));
	hl_hash((vbyte*)USTR("callback"));
	hl_hash((vbyte*)USTR("id"));
	hl_hash((vbyte*)USTR("Push"));
	hl_hash((vbyte*)USTR("DeleteTargets"));
	hl_hash((vbyte*)USTR("bigAircraft"));
	hl_hash((vbyte*)USTR("textBlock"));
	hl_hash((vbyte*)USTR("menuLight"));
	hl_hash((vbyte*)USTR("finished"));
	hl_hash((vbyte*)USTR("startPlay"));
	hl_hash((vbyte*)USTR("StartPlay"));
	...
	hl_hash((vbyte*)USTR("ExponentialIn"));
	hl_hash((vbyte*)USTR("ExponentialInOut"));
	hl_hash((vbyte*)USTR("ElasticIn"));
	hl_hash((vbyte*)USTR("ElasticOut"));
	hl_hash((vbyte*)USTR("ElasticInOut"));
	hl_hash((vbyte*)USTR("CardinalSplineAt"));
	...
	hl_hash((vbyte*)USTR("AddActions"));
	hl_hash((vbyte*)USTR("AddAction"));
	hl_hash((vbyte*)USTR("IsRunning"));
	hl_hash((vbyte*)USTR("Step"));
	hl_hash((vbyte*)USTR("_actions"));
	hl_hash((vbyte*)USTR("actionState"));
	hl_hash((vbyte*)USTR("get_Target"));
	hl_hash((vbyte*)USTR("set_Target"));
	hl_hash((vbyte*)USTR("IsDone"));
	hl_hash((vbyte*)USTR("firstTick"));
	hl_hash((vbyte*)USTR("Duration"));
	hl_hash((vbyte*)USTR("elapsed"));
	hl_hash((vbyte*)USTR("Target"));
	hl_hash((vbyte*)USTR("OriginalTarget"));
	hl_hash((vbyte*)USTR("Action"));
	hl_hash((vbyte*)USTR("get_Elapsed"));
	hl_hash((vbyte*)USTR("duration"));
	hl_hash((vbyte*)USTR("Tag"));
	hl_hash((vbyte*)USTR("isRepeatForever"));
	hl_hash((vbyte*)USTR("set_Duration"));
	...
	hl_hash((vbyte*)USTR("fromUIElement"));
	hl_hash((vbyte*)USTR("toUIElement"));
	hl_hash((vbyte*)USTR("get_text"));
	hl_hash((vbyte*)USTR("set_text"));
	hl_hash((vbyte*)USTR("get_horizontalAlignment"));
	hl_hash((vbyte*)USTR("set_horizontalAlignment"));
	hl_hash((vbyte*)USTR("get_verticalAlignment"));
	hl_hash((vbyte*)USTR("set_verticalAlignment"));
	hl_hash((vbyte*)USTR("AddChild"));
	hl_hash((vbyte*)USTR("SetFont"));
	hl_hash((vbyte*)USTR("get_systemTime"));
	...
	hl_hash((vbyte*)USTR("get_cursorPosition"));
	...
	hl_hash((vbyte*)USTR("isInited"));
	hl_hash((vbyte*)USTR("LastLaunchDate"));
	hl_hash((vbyte*)USTR("ReloadDuration"));
	hl_hash((vbyte*)USTR("Damage"));
	hl_hash((vbyte*)USTR("get_IsReloading"));
	hl_hash((vbyte*)USTR("OnHit"));
	hl_hash((vbyte*)USTR("FireAsync"));
	hl_hash((vbyte*)USTR("CreateRigidBullet"));
	hl_hash((vbyte*)USTR("OnFire"));
	hl_hash((vbyte*)USTR("EndScaleX"));
	hl_hash((vbyte*)USTR("EndScaleY"));
	hl_hash((vbyte*)USTR("EndScaleZ"));
	hl_hash((vbyte*)USTR("frontTile"));
	hl_hash((vbyte*)USTR("rearTile"));
	hl_hash((vbyte*)USTR("BackgroundRotationX"));
	hl_hash((vbyte*)USTR("BackgroundRotationY"));
	hl_hash((vbyte*)USTR("BackgroundScale"));
	hl_hash((vbyte*)USTR("BackgroundSpeed"));
	hl_hash((vbyte*)USTR("FlightHeight"));
	hl_hash((vbyte*)USTR("frontTilePos"));
	hl_hash((vbyte*)USTR("rearTilePos"));
	hl_hash((vbyte*)USTR("OnActionDone"));
	hl_hash((vbyte*)USTR("CreateBackGroundMovingAction"));
	hl_hash((vbyte*)USTR("SwitchTiles"));
	hl_hash((vbyte*)USTR("CreateTile"));
	hl_hash((vbyte*)USTR("PositionDelta"));
	hl_hash((vbyte*)USTR("bulletNodeRemove"));
	hl_hash((vbyte*)USTR("ControlPoint1"));
	hl_hash((vbyte*)USTR("ControlPoint2"));
	hl_hash((vbyte*)USTR("EndPosition"));
	hl_hash((vbyte*)USTR("AngleX"));
	hl_hash((vbyte*)USTR("AngleY"));
	hl_hash((vbyte*)USTR("AngleZ"));
	hl_hash((vbyte*)USTR("bezierConfig"));
	hl_hash((vbyte*)USTR("Actions"));
	hl_hash((vbyte*)USTR("InitSequence"));
	hl_hash((vbyte*)USTR("_CreateObject"));
	hl_hash((vbyte*)USTR("_enemy"));
	hl_hash((vbyte*)USTR("repeat"));
	hl_hash((vbyte*)USTR("repeat_counter"));
	hl_hash((vbyte*)USTR("msDelay"));
	hl_hash((vbyte*)USTR("get_isRepeat"));
	hl_hash((vbyte*)USTR("ResetRepeatCounter"));
	hl_hash((vbyte*)USTR("get_enemy"));
	hl_hash((vbyte*)USTR("set_enemy"));
	hl_hash((vbyte*)USTR("InitializedDone"));
	hl_hash((vbyte*)USTR("StartShooting"));
	hl_hash((vbyte*)USTR("ShootingLoop"));
	hl_hash((vbyte*)USTR("MoveRandomLoop"));
	hl_hash((vbyte*)USTR("repeatCounter"));
	hl_hash((vbyte*)USTR("At"));
	hl_hash((vbyte*)USTR("set_opIndex"));
	hl_hash((vbyte*)USTR("fromLeftSide"));
	hl_hash((vbyte*)USTR("StartMoveRandomLoop"));
	hl_hash((vbyte*)USTR("RemoveTargets"));
	hl_hash((vbyte*)USTR("get_PositionEnd"));
	hl_hash((vbyte*)USTR("Launch"));
	hl_hash((vbyte*)USTR("Fire"));
	hl_hash((vbyte*)USTR("GunOffsetSize"));
	hl_hash((vbyte*)USTR("currentGunOffset"));
	hl_hash((vbyte*)USTR("soundSource"));
	hl_hash((vbyte*)USTR("LaunchSingleMissile"));
	hl_hash((vbyte*)USTR("explosionNodeRemove"));
	hl_hash((vbyte*)USTR("InnerAction"));
	...
	hl_hash((vbyte*)USTR("InnerActionState"));
	hl_hash((vbyte*)USTR("StartPosition"));
	hl_hash((vbyte*)USTR("PreviousPosition"));
	hl_hash((vbyte*)USTR("ActionStates"));
	hl_hash((vbyte*)USTR("StartAngles"));
	hl_hash((vbyte*)USTR("DeltaX"));
	hl_hash((vbyte*)USTR("DeltaY"));
	hl_hash((vbyte*)USTR("DeltaZ"));
	hl_hash((vbyte*)USTR("StartScaleX"));
	hl_hash((vbyte*)USTR("StartScaleY"));
	hl_hash((vbyte*)USTR("StartScaleZ"));
	hl_hash((vbyte*)USTR("last"));
	hl_hash((vbyte*)USTR("actionSequences"));
	hl_hash((vbyte*)USTR("actionStates"));
	hl_hash((vbyte*)USTR("hasInfiniteAction"));
}
