...
typedef struct _hl_urho3d_ui_font hl_urho3d_ui_font;
typedef struct _hl_urho3d_ui_text hl_urho3d_ui_text;
...
HL_API hl_urho3d_ui_font* Urho3D__ui_font_create(urho3d_context*,String);
...
HL_API void Urho3D__ui_text_addchild(urho3d_context*,hl_urho3d_ui_text*,hl_urho3d_uielement*);
HL_API hl_urho3d_ui_text* Urho3D__ui_text_cast_from_uielement(urho3d_context*,hl_urho3d_uielement*);
HL_API hl_urho3d_uielement* Urho3D__ui_text_cast_to_uielement(urho3d_context*,hl_urho3d_ui_text*);
HL_API hl_urho3d_ui_text* Urho3D__ui_text_create(urho3d_context*);
HL_API int Urho3D__ui_text_get_horizontal_alignment(urho3d_context*,hl_urho3d_ui_text*);
HL_API vbyte* Urho3D__ui_text_get_text(urho3d_context*,hl_urho3d_ui_text*);
HL_API int Urho3D__ui_text_get_text_alignment(urho3d_context*,hl_urho3d_ui_text*);
HL_API int Urho3D__ui_text_get_vertical_alignment(urho3d_context*,hl_urho3d_ui_text*);
HL_API bool Urho3D__ui_text_set_font(urho3d_context*,hl_urho3d_ui_text*,hl_urho3d_ui_font*,float);
HL_API void Urho3D__ui_text_set_horizontal_alignment(urho3d_context*,hl_urho3d_ui_text*,int);
HL_API void Urho3D__ui_text_set_text(urho3d_context*,hl_urho3d_ui_text*,String);
HL_API void Urho3D__ui_text_set_text_alignment(urho3d_context*,hl_urho3d_ui_text*,int);
HL_API void Urho3D__ui_text_set_vertical_alignment(urho3d_context*,hl_urho3d_ui_text*,int);
