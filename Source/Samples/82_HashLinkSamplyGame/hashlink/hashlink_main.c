...
#  include <actions/FiniteTimeAction.c>
#  include <actions/FiniteTimeActionState.c>
#  include <actions/ActionDef.c>
#  include <actions/ActionID.c>
...
#  include <actions/ActionEase.c>
#  include <actions/ActionEaseState.c>
#  include <urho3d/_Context/Context_Impl_.c>
#  include <actions/ActionGroup.c>
#  include <actions/ActionManager.c>
#  include <actions/BezierConfig.c>
#  include <actions/BezierBy.c>
#  include <actions/BezierByState.c>
#  include <actions/DelayTime.c>
#  include <actions/DelayTimeState.c>
#  include <actions/EaseBackInOut.c>
#  include <actions/EaseBackInOutState.c>
#  include <actions/EaseRateAction.c>
#  include <actions/EaseRateActionState.c>
#  include <actions/EaseIn.c>
#  include <actions/EaseInState.c>
#  include <actions/EaseOut.c>
#  include <actions/EaseOutState.c>
#  include <actions/ExtraAction.c>
#  include <actions/ExtraActionState.c>
#  include <actions/MoveBy.c>
#  include <actions/MoveByState.c>
#  include <actions/MoveTo.c>
#  include <actions/MoveToState.c>
#  include <actions/Parallel.c>
#  include <actions/Sequence.c>
#  include <actions/ParallelState.c>
#  include <actions/RepeatForever.c>
#  include <actions/RepeatForeverState.c>
#  include <actions/RotateBy.c>
#  include <actions/RotateByState.c>
#  include <actions/ScaleTo.c>
#  include <actions/ScaleToState.c>
#  include <actions/SequenceState.c>
