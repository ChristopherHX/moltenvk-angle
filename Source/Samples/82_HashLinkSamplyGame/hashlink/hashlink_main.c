...
#  include <samplygame/StartMenu.c>
#  include <samplygame/Aircraft.c>
...
#  include <samplygame/Player.c>
#  include <samplygame/Enemy.c>
#  include <samplygame/SpawnEntry.c>
#  include <samplygame/SpawnArray.c>
#  include <samplygame/Enemies.c>
#  include <urho3d/DelayedCall.c>
#  include <samplygame/SamplyGame.c>
#  include <_std/Main.c>
#  include <_std/Std.c>
...
#  include <samplygame/Weapon.c>
#  include <urho3d/SoundSource.c>
#  include <urho3d/actions/ActionGroup.c>
#  include <urho3d/actions/ScaleTo.c>
#  include <urho3d/actions/DelayTime.c>
#  include <urho3d/ParticleEmitter2D.c>
#  include <samplygame/Background.c>
#  include <haxe/Log.c>
#  include <hl/types/ArrayDyn.c>
#  include <urho3d/Math.c>
#  include <urho3d/actions/MoveBy.c>
#  include <samplygame/BigWhiteCube.c>
#  include <urho3d/actions/BezierConfig.c>
#  include <urho3d/actions/RotateBy.c>
#  include <urho3d/actions/BezierBy.c>
#  include <urho3d/actions/Sequence.c>
#  include <samplygame/Coin.c>
#  include <urho3d/actions/Parallel.c>
#  include <samplygame/EnemySlotMachine.c>
#  include <samplygame/EnemyBat.c>
#  include <samplygame/SpawnMonitorScreenEntry.c>
#  include <samplygame/EnemyMonitorScreen.c>
#  include <urho3d/_Vector3/Vector3_Impl_.c>
#  include <urho3d/actions/MoveTo.c>
#  include <samplygame/SmallPlates.c>
#  include <samplygame/Joysticks.c>
#  include <samplygame/MachineGun.c>
#  include <samplygame/Missile.c>
#  include <urho3d/actions/RepeatForever.c>
#  include <urho3d/actions/ActionEase.c>
#  include <urho3d/actions/EaseRateAction.c>
#  include <urho3d/actions/EaseOut.c>
#  include <urho3d/actions/EaseBackInOut.c>
#  include <urho3d/Renderer.c>
#  include <urho3d/actions/EaseIn.c>
#  include <urho3d/Constraint.c>
#  include <urho3d/Graphics.c>
#  include <urho3d/_Vector2/Vector2_Impl_.c>
#  include <urho3d/actions/ActionEaseState.c>
#  include <urho3d/actions/ActionManager.c>
#  include <urho3d/actions/BezierByState.c>
#  include <urho3d/actions/DelayTimeState.c>
#  include <urho3d/actions/EaseBackInOutState.c>
#  include <urho3d/actions/EaseRateActionState.c>
#  include <urho3d/actions/EaseInState.c>
#  include <urho3d/actions/EaseOutState.c>
#  include <urho3d/actions/ExtraAction.c>
#  include <urho3d/actions/ExtraActionState.c>
#  include <urho3d/actions/MoveByState.c>
#  include <urho3d/actions/MoveToState.c>
#  include <urho3d/actions/ParallelState.c>
#  include <urho3d/actions/RepeatForeverState.c>
#  include <urho3d/actions/RotateByState.c>
#  include <urho3d/actions/ScaleToState.c>
#  include <urho3d/actions/SequenceState.c>
...
#  include <urho3d/_Font/Font_Impl_.c>
...
#  include <urho3d/_Text/Text_Impl_.c>
#  include <urho3d/_Texture/Texture_Impl_.c>
#  include <urho3d/Time.c>
