...
extern hl_type t$urho3d_$Controls;
...
extern hl_type t$utils_$Character;
...
void fun$init() {
	...
	r1 = &t$$CharacterDemoSample;
	r2 = &t$CharacterDemoSample;
	r3 = (vbyte*)USTR("CharacterDemoSample");
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$Date;
	r2 = &t$Date;
	r3 = (vbyte*)USTR("Date");
	...
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$urho3d_$Controls;
	r2 = &t$urho3d_Controls;
	r3 = (vbyte*)USTR("urho3d.Controls");
	r4 = Type_initClass(r1,r2,r3);
	...
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$utils_$Character;
	r2 = &t$utils_Character;
	r3 = (vbyte*)USTR("utils.Character");
	r4 = Type_initClass(r1,r2,r3);
