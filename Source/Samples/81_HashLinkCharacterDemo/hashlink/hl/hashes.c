...
void hl_init_hashes() {
	...
	hl_hash((vbyte*)USTR("characterNode"));
	hl_hash((vbyte*)USTR("firstPerson"));
	hl_hash((vbyte*)USTR("CTRL_FORWARD"));
	hl_hash((vbyte*)USTR("CTRL_BACK"));
	hl_hash((vbyte*)USTR("CTRL_LEFT"));
	hl_hash((vbyte*)USTR("CTRL_RIGHT"));
	hl_hash((vbyte*)USTR("CTRL_JUMP"));
	hl_hash((vbyte*)USTR("MOVE_FORCE"));
	hl_hash((vbyte*)USTR("INAIR_MOVE_FORCE"));
	hl_hash((vbyte*)USTR("BRAKE_FORCE"));
	hl_hash((vbyte*)USTR("JUMP_FORCE"));
	hl_hash((vbyte*)USTR("YAW_SENSITIVITY"));
	hl_hash((vbyte*)USTR("INAIR_THRESHOLD_TIME"));
	hl_hash((vbyte*)USTR("cameraDistance"));
	hl_hash((vbyte*)USTR("CAMERA_MIN_DIST"));
	hl_hash((vbyte*)USTR("patchInstructions"));
	hl_hash((vbyte*)USTR("CreateScene"));
	hl_hash((vbyte*)USTR("CreateCharacter"));
	hl_hash((vbyte*)USTR("SubscribeToEvents"));
	hl_hash((vbyte*)USTR("HandlePostUpdate"));
	...
	hl_hash((vbyte*)USTR("controls"));
	hl_hash((vbyte*)USTR("onGround"));
	hl_hash((vbyte*)USTR("okToJump"));
	hl_hash((vbyte*)USTR("inAirTimer"));
	hl_hash((vbyte*)USTR("HandleNodeCollision"));
	hl_hash((vbyte*)USTR("buttons"));
	hl_hash((vbyte*)USTR("yaw"));
	hl_hash((vbyte*)USTR("pitch"));
	hl_hash((vbyte*)USTR("extraData"));
	hl_hash((vbyte*)USTR("Set"));
