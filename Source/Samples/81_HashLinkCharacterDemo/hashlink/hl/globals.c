...
String s$CharacterDemoSample = 0;
String s$Octree = 0;
...
String s$Models_Mutant_Mutant_mdl = 0;
String s$16e6a02 = 0;
...
String s$Vector3_ = 0;
String s$NodeCollision = 0;
String s$HandleNodeCollision = 0;
String s$Models_Mutant_Mutant_Jump1_ani = 0;
String s$Models_Mutant_Mutant_Run_ani = 0;
String s$Models_Mutant_Mutant_Idle0_ani = 0;
String s$Contacts = 0;
...
static struct _String const_s$AdjNode = {&t$String,(vbyte*)USTR("AdjNode"),7};
static struct _String const_s$AnimatedModel = {&t$String,(vbyte*)USTR("AnimatedModel"),13};
static struct _String const_s$Models_Mutant_Mutant_mdl = {&t$String,(vbyte*)USTR("Models/Mutant/Mutant.mdl"),24};
static struct _String const_s$16e6a02 = {&t$String,(vbyte*)USTR("Models/Mutant/Materials/mutant_M.xml"),36};
static struct _String const_s$AnimationController = {&t$String,(vbyte*)USTR("AnimationController"),19};
static struct _String const_s$Mutant_Head = {&t$String,(vbyte*)USTR("Mutant:Head"),11};
...
static struct _String const_s$NodeCollision = {&t$String,(vbyte*)USTR("NodeCollision"),13};
static struct _String const_s$HandleNodeCollision = {&t$String,(vbyte*)USTR("HandleNodeCollision"),19};
static struct _String const_s$Models_Mutant_Mutant_Jump1_ani = {&t$String,(vbyte*)USTR("Models/Mutant/Mutant_Jump1.ani"),30};
static struct _String const_s$Models_Mutant_Mutant_Run_ani = {&t$String,(vbyte*)USTR("Models/Mutant/Mutant_Run.ani"),28};
static struct _String const_s$Models_Mutant_Mutant_Idle0_ani = {&t$String,(vbyte*)USTR("Models/Mutant/Mutant_Idle0.ani"),30};
static struct _String const_s$Contacts = {&t$String,(vbyte*)USTR("Contacts"),8};
...
void hl_init_roots() {
	...
	s$Box = &const_s$Box;
	s$Jack = &const_s$Jack;
	s$AdjNode = &const_s$AdjNode;
	s$AnimatedModel = &const_s$AnimatedModel;
	s$Models_Mutant_Mutant_mdl = &const_s$Models_Mutant_Mutant_mdl;
	s$16e6a02 = &const_s$16e6a02;
	s$AnimationController = &const_s$AnimationController;
	s$Mutant_Head = &const_s$Mutant_Head;
	...
	s$NodeCollision = &const_s$NodeCollision;
	s$HandleNodeCollision = &const_s$HandleNodeCollision;
	s$Models_Mutant_Mutant_Jump1_ani = &const_s$Models_Mutant_Mutant_Jump1_ani;
	s$Models_Mutant_Mutant_Run_ani = &const_s$Models_Mutant_Mutant_Run_ani;
	s$Models_Mutant_Mutant_Idle0_ani = &const_s$Models_Mutant_Mutant_Idle0_ani;
	s$Contacts = &const_s$Contacts;
