...
#ifndef INC__std__RagdollsSample
#define INC__std__RagdollsSample
typedef struct _$RagdollsSample *$RagdollsSample;
typedef struct _RagdollsSample *RagdollsSample;
#include <hl/Class.h>
