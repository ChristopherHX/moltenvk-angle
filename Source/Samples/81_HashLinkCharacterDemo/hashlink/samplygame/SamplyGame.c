...
void samplygame_SamplyGame_HandleUpdate(samplygame__SamplyGame r0,hl_urho3d_stringhash* r1,hl_urho3d_variantmap* r2) {
	...
	r9 = r0->startMenu_;
	if( !r9 ) goto label$0caf0a1_5_174;
	r9 = r0->startMenu_;
	if( r9 == NULL ) hl_null_access();
	r8 = r9->startPlay;
	r10 = true;
	if( r8 != r10 ) goto label$0caf0a1_5_174;
	r8 = r0->playing;
	r10 = false;
	if( r8 != r10 ) goto label$0caf0a1_5_174;
	r8 = true;
	...
	if( !r17 ) goto label$0caf0a1_5_57;
	...
	r21 = 0;
	r8 = false;
	r17 = Urho3D__scene_node_create_child(r19,r17,r5,r12,r21,r8);
	...
	r27 = (String)s$;
	if( r5 == r27 || (r5 && r27 && String___compare(r5,(vdynamic*)r27) == 0) ) goto label$0caf0a1_5_54;
	...
	if( !r17 ) goto label$0caf0a1_5_109;
	...
	if( r34 ) goto label$0caf0a1_5_102;
	r36 = &t$_dyn;
	r12 = 0;
	...
	label$0caf0a1_5_109:
	r29 = r0->player_;
	if( !r29 ) goto label$0caf0a1_5_173;
	...
	if( !r17 ) goto label$0caf0a1_5_165;
	...
	r30 = haxe_ds_StringMap_get(r28,r15);
	r34 = (hl__types__ArrayDyn)hl_dyn_castp(&r30,&t$_dyn,&t$hl_types_ArrayDyn);
	if( r34 ) goto label$0caf0a1_5_158;
	r36 = &t$_dyn;
	r12 = 0;
	r35 = hl_alloc_array(r36,r12);
	r37 = hl_types_ArrayObj_alloc(r35);
	...
	label$0caf0a1_5_173:
	goto label$0caf0a1_5_204;
	label$0caf0a1_5_174:
	r29 = r0->player_;
	if( !r29 ) goto label$0caf0a1_5_204;
	r29 = r0->player_;
	if( r29 == NULL ) hl_null_access();
	r8 = samplygame_Aircraft_IsAlive(((samplygame__Aircraft)r29));
	r10 = false;
	if( r8 != r10 ) goto label$0caf0a1_5_204;
	r8 = false;
	r0->playing = r8;
	r39 = r0->enemies_;
	if( r39 == NULL ) hl_null_access();
