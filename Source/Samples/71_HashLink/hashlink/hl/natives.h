...
HL_API int urho3d_fib(int);
HL_API void urho3d_pass_callback(vclosure*);
HL_API void urho3d_tick(int);
HL_API void urho3d_trace(String);
HL_API int urho3d_w_add_numbers(int,int);
#endif
