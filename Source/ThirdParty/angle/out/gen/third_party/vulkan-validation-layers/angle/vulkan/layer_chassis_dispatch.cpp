    ...
    while (cur_pnext != NULL) {
        ...
        switch (header->sType) {
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_ADDRESS_FEATURES_EXT: {
                    safe_VkPhysicalDeviceBufferAddressFeaturesEXT *safe_struct = new safe_VkPhysicalDeviceBufferAddressFeaturesEXT;
                    safe_struct->initialize(reinterpret_cast<const VkPhysicalDeviceBufferAddressFeaturesEXT *>(cur_pnext));
                    cur_ext_struct = reinterpret_cast<void *>(safe_struct);
                } break;
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETER_FEATURES: {
                    safe_VkPhysicalDeviceShaderDrawParameterFeatures *safe_struct = new safe_VkPhysicalDeviceShaderDrawParameterFeatures;
                    safe_struct->initialize(reinterpret_cast<const VkPhysicalDeviceShaderDrawParameterFeatures *>(cur_pnext));
                    cur_ext_struct = reinterpret_cast<void *>(safe_struct);
                } break;
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES: {
                    safe_VkPhysicalDeviceVariablePointerFeatures *safe_struct = new safe_VkPhysicalDeviceVariablePointerFeatures;
                    safe_struct->initialize(reinterpret_cast<const VkPhysicalDeviceVariablePointerFeatures *>(cur_pnext));
                    cur_ext_struct = reinterpret_cast<void *>(safe_struct);
                } break;
...
void FreeUnwrappedExtensionStructs(void *head) {
    ...
    while (curr_ptr) {
        ...
        switch (header->sType) {
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_ADDRESS_FEATURES_EXT:
                delete reinterpret_cast<safe_VkPhysicalDeviceBufferAddressFeaturesEXT *>(header);
                break;
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETER_FEATURES:
                delete reinterpret_cast<safe_VkPhysicalDeviceShaderDrawParameterFeatures *>(header);
                break;
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES:
                delete reinterpret_cast<safe_VkPhysicalDeviceVariablePointerFeatures *>(header);
                break;
